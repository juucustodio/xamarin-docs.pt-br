...
_Itálico_ Use para arquivos, pastas, caminhos (para itens longos, divididos em sua própria linha) – novos termos – URLs (a menos que sejam renderizadas como links, que é o padrão).
