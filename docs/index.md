...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Configuração e instalação</h3>
                                    <p>Saiba como instalar Ferramentas do Visual Studio para Xamarin.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Exemplos</h3>
                                    <p>Exemplos de recursos e aplicativos predefinidos.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Novidades</h3>
                                    <p>Veja as novidades nos documentos do Xamarin.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="screenReader">Documentação do Xamarin</h1>
        <ul class="pivots">
            <li>
                <li>
                            ...
                            <li>
                               <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Saiba mais sobre o Xamarin</h3>
                                                <h4>Crie aplicativo para Android e iOS multiplataforma com o Xamarin.Forms usando C# e .NET no Visual Studio em Windows e macOS.</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="~/cross-platform/get-started/introduction-to-mobile-development.md"><img  src="https://docs.microsoft.com/media/logos/logo_xamarin.svg" alt="" />O que é o Xamarin?</a></li>
                                                    ...
                                                    <li><a class="barLink" href="~/xamarin-forms/data-cloud/index.yml"><img  src="https://docs.microsoft.com/media/logos/logo_azure.svg" alt="" />Azure com Xamarin</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <h4>Siga estes guias para criar seu primeiro aplicativo para Android e iOS multiplataforma com Xamarin.Forms, 5 minutos por vez.</h4>
                                                            ...
                                                            <ul class="noBullet">
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/quickstarts/single-page.md">
                                                                        <img src="~/media/icons/i_xaml-forms.svg" alt=""> Arquivo > Novo aplicativo móvel </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/quickstarts/multi-page.md">
                                                                        <img src="https://docs.microsoft.com/media/common/i_class.svg" alt=""> Adicionar navegação </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/quickstarts/database.md">
                                                                        <img src="https://docs.microsoft.com/media/common/i_generic-database.svg" alt=""> Adicionar um banco de dados </a>
                                                                </li>
                                                                 <li>
                                                                    <a class="barLink" href="~/get-started/quickstarts/styling.md">
                                                                        <img src="https://docs.microsoft.com/xamarin/media/icons/i_user-interface.svg" alt=""> Definir o estilo do aplicativo </a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                        ...
                                                        <td style="border-top-color:transparent!important;padding-left:0;">
                                                            <ul class="noBullet">
                                                                <li>
                                                                    ...
                                                                    <img src="https://docs.microsoft.com/media/common/i_guidelines.svg" alt=""> Diretrizes de desenvolvimento do Xamarin</a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Tutoriais</h3>
                                                <h4>Aprenda conceitos de aplicativo Android e iOS multiplataforma com Xamarin.Forms.</h4>
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="border-top-color:transparent!important;padding-left:0;">
                                                            <ul class="noBullet">
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/stacklayout/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_dashboard.svg" alt=""> Layout empilhado </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/label/index.yml">
                                                                        <img src="~/media/icons/i_form-label.svg" alt=""> Rótulo </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/button/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_button.svg" alt=""> Botões </a>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/image/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_account-management.svg" alt=""> Imagens </a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                        <td style="border-top-color:transparent!important;padding-left:0;">
                                                            <ul class="noBullet">
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/grid/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_table.svg" alt=""> Layout de grade </a>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/pop-ups/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_alert.svg" alt=""> Pop-ups </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/app-lifecycle/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_agile.svg" alt=""> Ciclo de vida do aplicativo </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/local-database/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_generic-database.svg" alt=""> Banco de dados </a>
                                                                </li>
                                                                <li>
                                                                    <a class="barLink" href="~/get-started/tutorials/web-service/index.yml">
                                                                        <img src="https://docs.microsoft.com/media/common/i_server.svg" alt=""> Serviços Web </a>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Aproveitar o conhecimento existente</h3>
                                                <h4>Os projetos do Xamarin permitem que você aplique suas habilidades atuais para criar aplicativos Android e iOS. Escolha sua plataforma favorita para obter mais detalhes:</h4>
                                                ...
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="~/cross-platform/desktop/index.md">
                                                            <img src="https://docs.microsoft.com/media/logos/logo_NET.svg" alt=""> Área de trabalho do .NET (UWP, WPF, WinForms)</a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="~/android/get-started/java-developers.md">
                                                            <img src="https://docs.microsoft.com/media/logos/logo_java.svg" alt=""> Android e Java</a>
                                                    </li>
                                                    </ul></td><td style="border-top-color:transparent!important;padding-left:0;"><ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="~/ios/get-started/objective-c-developers/index.md">
                                                            <img src="https://docs.microsoft.com/media/logos/logo_xcode.svg" alt=""> iOS e Objective-C</a>
                                                    </li>
                                                </ul></td></tr></table>
                                            </div>
                                        </div>
                        ...
                        <ul id="XamarinForms" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>
O Xamarin.Forms é um kit de ferramentas multiplataforma para Android, iOS, Mac e Windows usando o C# e o .NET. Compartilhe o código de interface do usuário e o código de lógica de aplicativo em todas as plataformas.
                                    </p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>O que é o Xamarin.Forms?</h3>
                                                    <p>Explica o que é o Xamarin.Forms e como ele ajuda a criar e implantar aplicativos Android e iOS.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Tudo que você precisa saber para desenvolver aplicativos Xamarin.Forms, como navegação, gestos, associação de dados e mais.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Saiba mais sobre os controles de interface do usuário disponíveis em todas as plataformas com suporte.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>XAML</h3>
                                                    <p>Expressar interfaces do usuário de plataforma cruzada declarativamente com XAML.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Trabalhar com recursos específicos à plataforma no Windows, iOS e Android.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>APIs multiplataforma para tarefas comuns de aplicativo.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Dados e Serviços de Nuvem do Azure</h3>
                                                    <p>Armazenamento de dados e acesso aos serviços de nuvem do Azure.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Instruções para compilação e implantação de aplicativos e dicas para testá-los com antecedência.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Conceitos avançados e recursos internos</h3>
                                                    <p>Como funciona o Xamarin.Forms.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Aplicativos de exemplo</h3>
                                                    <p>Complete demonstrações de códigos e aplicativos para Xamarin.Forms, em execução no Windows, iOS e Android.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Livro eletrônico de elementos gráficos de SkiaSharp</h3>
                                                    <p>Gráficos vetoriais multiplataforma e animação com SkiaSharp.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Livro sobre aplicativos móveis</h3>
                                                    <p>Aprenda o passo a passo do Xamarin.Forms com este livro e seus exemplos.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Livro eletrônico corporativo</h3>
                                                    <p>Diretrizes de arquitetura para desenvolvimento de aplicativos corporativos testáveis adaptáveis e sustentáveis de Xamarin.Forms.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Saiba mais sobre o desenvolvimento de .NET no macOS com o Visual Studio para Mac.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Simulador de iOS para Windows</h3>
                                                    <p>Interagir com o Simulador de iOS usando o Visual Studio no Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>.NET Embedding</h3>
                                                    <p>Permite que seu código .NET existente seja consumido a partir de outras linguagens de programação.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Como incorporar projetos Xamarin em um pipeline de compilação e integração contínua.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>UrhoSharp</h3>
                                                    <p>Jogos e gráficos 3D de plataforma cruzada.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MonoGame</h3>
                                                    <p>Compile jogos de desktop, móveis e de console com C#.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
