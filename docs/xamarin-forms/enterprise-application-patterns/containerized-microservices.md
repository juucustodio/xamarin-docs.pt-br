...
description: Este capítulo explica como usar microservices e contêineres para criar agile, escalonável e aplicativos de nuvem modernos confiável.
ms.prod: xamarin
