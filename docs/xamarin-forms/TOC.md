...
### [Criar seu primeiro aplicativo](~/get-started/first-app/index.md)
...
#### [Parte 2. Sintaxe essencial do XAML](xaml/xaml-basics/essential-xaml-syntax.md)
#### [Parte 3. Extensões de marcação do XAML](xaml/xaml-basics/xaml-markup-extensions.md)
...
### [Visualizador do XAML](xaml/xaml-previewer/index.md)
...
### [Esquemas personalizados de namespace do XAML](xaml/custom-namespace-schemas.md)
### [Prefixos recomendados de namespace do XAML](xaml/custom-prefix.md)
### [Extensões de marcação do XAML](xaml/markup-extensions/index.md)
#### [Consumo de extensões de marcação do XAML](xaml/markup-extensions/consuming.md)
#### [Criação de extensões de marcação do XAML](xaml/markup-extensions/creating.md)
### [Modificadores de campo](xaml/field-modifiers.md)
### [Passando argumentos](xaml/passing-arguments.md)
### [Propriedades associáveis](xaml/bindable-properties.md)
### [Propriedades anexadas](xaml/attached-properties.md)
### [Dicionários de recurso](xaml/resource-dictionaries.md)
### [XAML Standard (Versão prévia)](xaml/standard/index.md)
...
#### [Classes base de renderizador e controles nativos](app-fundamentals/custom-renderer/renderers.md)
#### [Personalizando uma entrada](app-fundamentals/custom-renderer/entry.md)
#### [Personalizando uma ContentPage](app-fundamentals/custom-renderer/contentpage.md)
#### [Personalizando um mapa](app-fundamentals/custom-renderer/map/index.md)
##### [Personalizando um marcador de mapa](app-fundamentals/custom-renderer/map/customized-pin.md)
##### [Realçando uma área circular em um mapa](app-fundamentals/custom-renderer/map/circle-map-overlay.md)
##### [Realçando uma região em um mapa](app-fundamentals/custom-renderer/map/polygon-map-overlay.md)
##### [Realçando uma rota em um mapa](app-fundamentals/custom-renderer/map/polyline-map-overlay.md)
#### [Personalizando uma ListView](app-fundamentals/custom-renderer/listview.md)
#### [Personalizando um ViewCell](app-fundamentals/custom-renderer/viewcell.md)
#### [Implementando uma exibição](app-fundamentals/custom-renderer/view.md)
#### [Implementando um HybridWebView](app-fundamentals/custom-renderer/hybridwebview.md)
#### [Implementando um player de vídeo](app-fundamentals/custom-renderer/video-player/index.md)
##### [Criando os players de vídeo da plataforma](app-fundamentals/custom-renderer/video-player/player-creation.md)
##### [Reproduzindo um vídeo da Web](app-fundamentals/custom-renderer/video-player/web-videos.md)
##### [Associando fontes de vídeo ao player](app-fundamentals/custom-renderer/video-player/source-bindings.md)
##### [Carregando vídeos de recursos do aplicativo](app-fundamentals/custom-renderer/video-player/loading-resources.md)
##### [Acessando a biblioteca de vídeos do dispositivo](app-fundamentals/custom-renderer/video-player/accessing-library.md)
##### [Controles de transporte de vídeo personalizado](app-fundamentals/custom-renderer/video-player/custom-transport.md)
...
#### [Associação de conversores de valor](app-fundamentals/data-binding/converters.md)
#### [Associação de fallbacks](app-fundamentals/data-binding/binding-fallbacks.md)
...
#### [Implementando a conversão de texto em fala](app-fundamentals/dependency-service/text-to-speech.md)
#### [Verificando a orientação do dispositivo](app-fundamentals/dependency-service/device-orientation.md)
#### [Verificando o status da bateria](app-fundamentals/dependency-service/battery-info.md)
#### [Selecionando da biblioteca de fotos](app-fundamentals/dependency-service/photo-picker.md)
### [Efeitos](app-fundamentals/effects/index.md)
#### [Introdução](app-fundamentals/effects/introduction.md)
#### [Criação de efeitos](app-fundamentals/effects/creating.md)
#### [Passar parâmetros](app-fundamentals/effects/passing-parameters/index.md)
...
#### [Fixar](app-fundamentals/gestures/pinch.md)
...
#### [Localização de cadeias de caracteres e imagens](app-fundamentals/localization/text.md)
#### [Localização da direita para a esquerda](app-fundamentals/localization/right-to-left.md)
...
#### [Exibindo pop-ups](app-fundamentals/navigation/pop-ups.md)
...
### [Botão](user-interface/button.md)
...
#### [Pages (Páginas)](user-interface/controls/pages.md)
...
#### [Criando um layout personalizado](user-interface/layouts/custom.md)
...
### [Controle deslizante](user-interface/slider.md)
### [Passador](user-interface/stepper.md)
### [Estilos](user-interface/styles/index.md)
#### [Aplicar estilo a aplicativos do Xamarin.Forms usando os estilos do XAML](user-interface/styles/xaml/index.md)
...
#### [Rotular](user-interface/text/label.md)
...
### [Gerenciador de Estado Visual](user-interface/visual-state-manager.md)
...
#### [Botão de sombras e preenchimento](platform/android/button-padding-shadow.md)
...
#### [Estilo do cabeçalho de grupo de ListView](platform/ios/listview-group-header-style.md)
...
#### [Exibições nativas em XAML](platform/native-views/xaml.md)
...
### [Informações sobre o dispositivo](~/essentials/device-information.md?context=xamarin/xamarin-forms)
...
### [Compartilhar](~/essentials/share.md?context=xamarin/xamarin-forms)
...
### [Noções básicas de exemplo](data-cloud/walkthrough.md)
...
### [Autenticar o acesso aos serviços Web](data-cloud/authentication/index.md)
...
#### [Verificação de](data-cloud/serverless/azure-functions.md)
...
### [Como publicar aplicativos iOS](~/ios/deploy-test/app-distribution/index.md)
### [Como publicar aplicativos Android](~/android/deploy-test/publishing/index.md)
### [Como publicar aplicativos UWP](/windows/uwp/packaging/)
### [Como publicar aplicativos Mac](~/mac/deploy-test/publishing-to-the-app-store/index.md)
### [Desempenho](deploy-test/performance.md)
### [Testes automatizados no Visual Studio App Center](/appcenter/test-cloud/uitest/get-started-xamarin-forms)
...
## [Livro eletrônico de padrões de aplicativo empresarial](enterprise-application-patterns/index.md)
