...
3. Na caixa de diálogo **Novo Projeto**, clique em **Plataforma Cruzada**, selecione o modelo **Aplicativo de Plataforma Cruzada (Xamarin.Forms)**, defina o Nome e o Nome da Solução como `Phoneword`, escolha um local adequado para o projeto e clique no botão **OK**:

    ![](quickstart-images/vs/new-project.png "Modelos de Projeto de Multiplataforma")

4. Na caixa de diálogo **Novo Aplicativo de Plataforma Cruzada**, clique em **Aplicativo em Branco**, selecione **Xamarin.Forms** como a tecnologia de interface do usuário, selecione **.NET Standard** como a estratégia de compartilhamento de código e clique no botão **OK**:
...
18. Na caixa de diálogo **Adicionar novo item**, selecione **Apple > Código > Classe**, nomeie o novo arquivo **PhoneDialer** e clique no botão **Adicionar**:
