...
O `ImageSource` propriedade é do tipo [ `ImageSource` ](xref:Xamarin.Forms.ImageSource), o que significa que os bitmaps podem ser carregados de um arquivo, o recurso inserido, o URI ou o fluxo.
