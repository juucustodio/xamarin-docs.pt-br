...
description: Páginas xamarin. Forms representam as telas de aplicativos móveis de plataforma cruzada. Este artigo lista as páginas que estão incluídas no xamarin. Forms.
ms.prod: xamarin
