...
|     |     |
| --- | --- |
| [`MediaElement`](xref:Xamarin.Forms.MediaElement) reproduz vídeo ou áudio. A mídia pode ser reproduzida a partir de uma URL ou de um arquivo local, com base em se a propriedade [`Source`](xref:Xamarin.Forms.MediaElement.Source) está definida como uma [`UriMediaSource`](xref:Xamarin.Forms.UriMediaSource) ou uma [`FileMediaSource`](xref:Xamarin.Forms.FileMediaSource).<br /><br />[Documentação da API](xref:Xamarin.Forms.MediaElement) / [guia](~/xamarin-forms/user-interface/mediaelement.md) / [exemplo](https://docs.microsoft.com/samples/xamarin/xamarin-forms-samples/userinterface-mediaelementdemos) | [![Exemplo de MediaElement](views-images/MediaElement.png "Exemplo de MediaElement")](views-images/MediaElement-Large.png#lightbox "Exemplo de MediaElement")<br />código desta página / [página XAML](https://github.com/xamarin/xamarin-forms-samples/blob/master/FormsGallery/FormsGallery/FormsGallery/XamlExamples/MediaElementDemoPage.xaml) [ C# ](https://github.com/xamarin/xamarin-forms-samples/blob/master/FormsGallery/FormsGallery/FormsGallery/CodeExamples/MediaElementDemoPage.cs) |
|     |     |
...
|     |     |
| --- | --- |
| `IndicatorView` exibe os indicadores que representam o número de itens em um `CarouselView`. Defina a propriedade `CarouselView.IndicatorView` como o objeto `IndicatorView` para exibir indicadores para o `CarouselView`. <br /><br />[Guia](~/xamarin-forms/user-interface/indicatorview.md) / [exemplo](https://docs.microsoft.com/samples/xamarin/xamarin-forms-samples/userinterface-indicatorviewdemos/) | [![Exemplo de IndicatorView](views-images/IndicatorView.png "Exemplo de IndicatorView")](views-images/IndicatorView-Large.png#lightbox "Exemplo de IndicatorView")<br />código desta página / [página XAML](https://github.com/xamarin/xamarin-forms-samples/blob/master/FormsGallery/FormsGallery/FormsGallery/XamlExamples/IndicatorViewDemoPage.xaml) [ C# ](https://github.com/xamarin/xamarin-forms-samples/blob/master/FormsGallery/FormsGallery/FormsGallery/CodeExamples/IndicatorViewDemoPage.cs) |
|     |     |
