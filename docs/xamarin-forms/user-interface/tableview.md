---
title: Modo de tabela xamarin. Forms
description: Este artigo explica como usar a classe de modo de tabela xamarin. Forms para apresentar os menus de rolagem, configurações e formulários de entrada de aplicativos.
ms.prod: xamarin
...
ms.locfileid: "35244852"
---
# <a name="xamarinforms-tableview"></a>Modo de tabela xamarin. Forms
