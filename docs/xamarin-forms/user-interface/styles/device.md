...
[![](device-images/minimum-size.png "Estilos de dispositivo pequeno acessível em cada plataforma")](device-images/minimum-size-large.png "estilos de dispositivo pequeno acessível em cada plataforma")
