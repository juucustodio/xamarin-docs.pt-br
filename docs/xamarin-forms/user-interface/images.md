...
Enquanto não relacionados para o [ `Image` ](xref:Xamarin.Forms.Image) exibição, os ícones de aplicativo e splashscreens também são um importante uso das imagens em projetos do xamarin. Forms.
