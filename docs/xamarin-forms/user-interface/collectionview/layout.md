...
No entanto, para fins de [`CollectionView`](xref:Xamarin.Forms.CollectionView) integridade, um pode ser definido para exibir seus itens em uma lista vertical [`ItemsLayout`](xref:Xamarin.Forms.StructuredItemsView.ItemsLayout) definindo sua `VerticalList`Propriedade como:
...
[`CollectionView`](xref:Xamarin.Forms.CollectionView)pode exibir seus itens em uma lista horizontal definindo sua [`ItemsLayout`](xref:Xamarin.Forms.StructuredItemsView.ItemsLayout) Propriedade como: `HorizontalList`
...
[`CollectionView`](xref:Xamarin.Forms.CollectionView)pode exibir seus itens em uma grade [`ItemsLayout`](xref:Xamarin.Forms.StructuredItemsView.ItemsLayout) vertical definindo sua propriedade como um [`GridItemsLayout`](xref:Xamarin.Forms.GridItemsLayout) objeto cuja [`Orientation`](xref:Xamarin.Forms.ItemsLayout.Orientation) Propriedade está definida como: `Vertical`
...
[`CollectionView`](xref:Xamarin.Forms.CollectionView)pode exibir seus itens em uma grade [`ItemsLayout`](xref:Xamarin.Forms.StructuredItemsView.ItemsLayout) horizontal definindo sua propriedade como um [`GridItemsLayout`](xref:Xamarin.Forms.GridItemsLayout) objeto cuja[`Orientation`](xref:Xamarin.Forms.ItemsLayout.Orientation) Propriedade está definida como: `Horizontal`
...
As `Header` propriedades `Footer` e podem ser definidas como `string` valores, conforme mostrado no exemplo a seguir:
...
O exemplo de código a seguir mostra [`ItemSizingStrategy`](xref:Xamarin.Forms.StructuredItemsView.ItemSizingStrategy) a definição da propriedade:
