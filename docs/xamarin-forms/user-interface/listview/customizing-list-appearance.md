...
description: Este artigo explica como personalizar ListViews em aplicativos xamarin. Forms usando cabeçalhos, rodapés, grupos e as células de altura variável.
ms.prod: xamarin
