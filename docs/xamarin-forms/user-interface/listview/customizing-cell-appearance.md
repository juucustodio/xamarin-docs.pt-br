---
title: Personalizando a aparência da célula de ListView
description: Este artigo explora opções para apresentar dados em aplicativos xamarin. Forms, aproveitando as vantagens da conveniência do controle ListView.
ms.prod: xamarin
...
ms.locfileid: "35244750"
---
# <a name="customizing-listview-cell-appearance"></a>Personalizando a aparência da célula de ListView
