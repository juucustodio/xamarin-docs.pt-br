...
description: Este artigo explica como usar os dedos para pintar na tela SkiaSharp em um aplicativo xamarin. Forms e demonstra isso com o código de exemplo.
ms.prod: xamarin
