...
description: Este artigo explica como animar SkiaSharp elementos gráficos em aplicativos xamarin. Forms e demonstra isso com o código de exemplo.
ms.prod: xamarin
