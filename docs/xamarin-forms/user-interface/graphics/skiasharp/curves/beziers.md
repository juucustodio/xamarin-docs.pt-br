...
description: Este artigo explica como usar SkiaSharp para renderizar cúbicas, quadráticas e conic curvas de Bézier em aplicativos xamarin. Forms e demonstra isso com o código de exemplo.
ms.prod: xamarin
