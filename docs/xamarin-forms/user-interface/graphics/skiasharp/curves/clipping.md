...
description: Este artigo explica como usar caminhos SkiaSharp para gráficos de clipe para áreas específicas e para criar as regiões e demonstra isso com o código de exemplo.
ms.prod: xamarin
