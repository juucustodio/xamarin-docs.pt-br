...
description: Este artigo explica os vários efeitos de caminho SkiaSharp permitem caminhos a ser usada para traçar e o preenchimento e demonstra isso com o código de exemplo.
ms.prod: xamarin
