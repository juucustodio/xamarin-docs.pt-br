...
description: Thhis artigo explora a transformação de escala SkiaSharp para dimensionamento de objetos para vários tamanhos e demonstra isso com o código de exemplo.
ms.prod: xamarin
