...
description: CocosSharp pode ser usado para adicionar processamento preciso de forma, imagem e texto a um aplicativo para visualização avançada
ms.prod: xamarin
...
O CocosSharp é uma tecnologia flexível e poderosa para a exibição de gráficos, a leitura de entrada por toque, a reprodução de áudio e o gerenciamento de conteúdo. Este guia explica como adicionar o CocosSharp a um Xamarin.Forms aplicativo.
...
![Caixa de diálogo adicionar pacotes](cocossharp-images/image1.png)

Os pacotes NuGet **CocosSharp** e **CocosSharp. Forms** serão adicionados ao projeto:

![Pasta de pacotes](cocossharp-images/image2.png)
...
1. [Criando uma página de formulários do Xamarin](#1-creating-a-xamarin-forms-page)
1. [Adicionando um CocosSharpView](#2-adding-a-cocossharpview)
1. [Criando o GameScene](#3-creating-the-gamescene)
1. [Adicionando um círculo](#4-adding-a-circle)
1. [Interagindo com CocosSharp](#5-interacting-with-cocossharp)
...
![Captura de tela da Home Page](cocossharp-images/image3.png)
...
![Hierarquia de CocosSharp típica](cocossharp-images/image4.png)
...
![GameScene em branco](cocossharp-images/image5.png)
...
![Círculo em GameScene](cocossharp-images/image6.png)
...
![Resolução de design do iPhone 5s](cocossharp-images/image7.png)
...
![GameScene com círculo móvel](cocossharp-images/image8.png)
