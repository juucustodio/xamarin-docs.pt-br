...
description: Este artigo fornece uma introdução a um aplicativo de exemplo que demonstra como invocar algumas das APIs Microsoft cognitivas serviço.
ms.prod: xamarin
