...
description: Este artigo explica como usar a classe de dispositivo xamarin. Forms, de um controle refinado sobre layouts e funcionalidade em uma base por plataforma.
ms.prod: xamarin
