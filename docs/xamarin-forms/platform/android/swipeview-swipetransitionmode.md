---
Título: "modo de transição do SwipeView do dedo no Android" Descrição: "as especificações da plataforma permitem que você consuma a funcionalidade disponível apenas em uma plataforma específica, sem implementar renderizadores ou efeitos personalizados. Este artigo explica como consumir a plataforma Android específica que controla a transição usada ao abrir um SwipeView. "
MS. Prod: xamarin MS. AssetID: 6B1F8213-9D62-4C40-9F04-881F1371B5AA MS. Technology: xamarin-Forms autor: davidbritch MS. Author: dabritch MS. Date: 12/11/2019 no-loc: [ Xamarin.Forms , Xamarin.Essentials ]
---
