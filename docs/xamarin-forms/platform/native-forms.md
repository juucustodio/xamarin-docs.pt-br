...
description: Este artigo explica como utilizar páginas ContentPage derivadas que são adicionadas diretamente ao projetos nativos do Xamarin e como navegar entre eles.
ms.prod: xamarin
