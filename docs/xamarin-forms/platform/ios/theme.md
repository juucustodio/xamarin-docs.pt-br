...
description: Este artigo explica como definir a aparência de específico do iOS sem usar um renderizador personalizado xamarin. Forms.
ms.prod: xamarin
