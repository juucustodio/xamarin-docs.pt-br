---
title: Estilo de apresentação de página Modal do iPad
...
ms.locfileid: "54209081"
---
# <a name="ipad-modal-page-presentation-style"></a>Estilo de apresentação de página Modal do iPad
