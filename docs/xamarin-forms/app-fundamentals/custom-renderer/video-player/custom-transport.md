...
description: Este artigo explica como implementar controles de transporte personalizado em um aplicativo de player de vídeo, usando o xamarin. Forms.
ms.prod: xamarin
