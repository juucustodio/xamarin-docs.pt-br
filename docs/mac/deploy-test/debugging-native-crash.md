---
title: "Depuração de uma falha nativa"
description: "Este guia descreve como depurar exceções originadas no tempo de execução Objective-C."
ms.topic: article
ms.prod: xamarin
...
---
# <a name="debugging-a-native-crash"></a>Depuração de uma falha nativa
