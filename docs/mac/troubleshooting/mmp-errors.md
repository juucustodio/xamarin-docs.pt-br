...
description: Este documento lista os erros gerados por mmp, a ferramenta usada para assemblies compilados em um aplicativo do Mac executável do pacote.
