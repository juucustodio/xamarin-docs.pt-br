...
2. Na janela **criar um novo projeto** , selecione **móvel** na lista suspensa **tipo de projeto** , selecione o **aplicativo móvel (modelo Xamarin. Forms** ) e clique no botão **Avançar** :
