...
description: Este documento descreve o DataAccess_Adv Criar amostra, que demonstra como coletar entrada do usuário e executar, ler, atualizar e excluir operações de banco de dados (CRUD) em um aplicativo xamarin.
ms.prod: xamarin
