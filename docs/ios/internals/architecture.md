...
Xamarin. IOS contém definições para cada API única do iOS. Você pode procurar por meio de qualquer um na [repositório do github MaciOS](https://github.com/xamarin/xamarin-macios/tree/master/src). Essas definições contêm interfaces com atributos, bem como quaisquer métodos necessários e propriedades. Por exemplo, é o código a seguir é usado para definir um UIToolbar no UIKit [namespace](https://github.com/xamarin/xamarin-macios/blob/master/src/uikit.cs#L11277-L11327). Observe que se trata de uma interface com um número de métodos e propriedades:
