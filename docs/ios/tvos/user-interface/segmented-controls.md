...
Em que a `UIControlState` primeira especifica o estado do segmento à esquerda do divisor e o segundo `UIControlState` especifica o estado do segmento à direita.
