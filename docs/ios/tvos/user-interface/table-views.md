---
title: Trabalhando com tvOS modos de exibição de tabela no Xamarin
...
ms.locfileid: "34789561"
---
# <a name="working-with-tvos-table-views-in-xamarin"></a>Trabalhando com tvOS modos de exibição de tabela no Xamarin
