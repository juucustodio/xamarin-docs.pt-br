...
[![O WKURLSessionRefreshBackgroundTask quando os dados concluíram o download](background-tasks-images/update05.png)](background-tasks-images/update05.png#lightbox)
