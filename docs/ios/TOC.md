...
#### [Parte 1: Guia de Início Rápido](get-started/hello-ios/hello-ios-quickstart.md)
...
#### [Parte 1: Guia de Início Rápido](get-started/hello-ios-multiscreen/hello-ios-multiscreen-quickstart.md)
...
#### [Manual de introdução a C# para Desenvolvedores de Objective-C](get-started/objective-c-developers/primer.md)
## [Conceitos básicos de aplicativo](app-fundamentals/index.md)
### [Acessibilidade](app-fundamentals/accessibility.md)
### [Segurança do transporte de aplicativo](app-fundamentals/ats.md)
### [Operação em segundo plano](app-fundamentals/backgrounding/index.md)
#### [Introdução à operação em segundo plano no iOS](app-fundamentals/backgrounding/introduction-to-backgrounding-in-ios.md)
#### [Demonstração do ciclo de vida do aplicativo](app-fundamentals/backgrounding/application-lifecycle-demo.md)
#### [Técnicas de operação em segundo plano no iOS](app-fundamentals/backgrounding/ios-backgrounding-techniques/index.md)
##### [Operação em segundo plano no iOS com tarefas](app-fundamentals/backgrounding/ios-backgrounding-techniques/ios-backgrounding-with-tasks.md)
##### [Como registrar aplicativos para execução em segundo plano](app-fundamentals/backgrounding/ios-backgrounding-techniques/registering-applications-to-run-in-background.md)
##### [Como atualizar um aplicativo em segundo plano](app-fundamentals/backgrounding/ios-backgrounding-techniques/updating-an-application-in-the-background.md)
#### [Instruções passo a passo: Operação em segundo plano no iOS](app-fundamentals/backgrounding/ios-backgrounding-walkthroughs/index.md)
##### [Passo a passo: Local de segundo plano](app-fundamentals/backgrounding/ios-backgrounding-walkthroughs/location-walkthrough.md)
...
#### [Diretrizes de operação em segundo plano do iOS](app-fundamentals/backgrounding/ios-backgrounding-guidance.md)
### [Como criar uma interface do usuário iOS no Código](app-fundamentals/ios-code-only.md)
...
#### [Como exibir uma imagem](app-fundamentals/images-icons/displaying-an-image.md)
...
#### [Passo a passo: Como usar o toque no iOS](app-fundamentals/touch/ios-touch-walkthrough.md)
...
### [Designer do iOS](user-interface/designer/index.md)
...
#### [Passo a passo: Como usar controles personalizados com o iOS Designer](user-interface/designer/ios-designable-controls-walkthrough.md)
...
#### [Como criar objetos de interface do usuário](user-interface/ios-ui/creating-ui-objects.md)
#### [Opções de layout](user-interface/ios-ui/layout-options.md)
#### [Como fornecer comentários hápticos](user-interface/ios-ui/haptic-feedback.md)
#### [Como trabalhar com o thread de interface do usuário](user-interface/ios-ui/ui-thread.md)
...
##### [Como popular uma tabela usando dados](user-interface/controls/tables/populating-a-table-with-data.md)
##### [Como personalizar a aparência de uma tabela](user-interface/controls/tables/customizing-table-appearance.md)
##### [Edição](user-interface/controls/tables/editing.md)
##### [Como trabalhar com ações de linha](user-interface/controls/tables/row-action.md)
##### [Como trabalhar com tabelas no iOS Designer](user-interface/controls/tables/creating-tables-in-a-storyboard.md)
##### [Como dimensionar automaticamente a altura da linha](user-interface/controls/tables/autosizing-row-height.md)
...
#### [Passo a passo: Como criar um aplicativo usando a API de elementos](user-interface/monotouch.dialog/elements-api-walkthrough.md)
#### [Passo a passo: Como usar um JSON para criar uma Interface do usuário](user-interface/monotouch.dialog/json-element-walkthrough.md)
#### [Markup Json MonoTouch.Dialog](user-interface/monotouch.dialog/monotouch.dialog-json-markup.md)
#### [Passo a passo: Como criar um aplicativo usando a API de reflexão](user-interface/monotouch.dialog/reflection-api-walkthrough.md)
...
#### [Notificações](platform/introduction-to-ios12/notifications/index.md)
...
#### [Guia de Introdução](platform/introduction-to-ios11/get-started.md)
#### [Como atualizar seu aplicativo para iOS 11](platform/introduction-to-ios11/updating-your-app/index.md)
...
#### [Passo a passo: Como associar uma biblioteca Objective-C do iOS](platform/binding-objective-c/walkthrough.md)
...
### [Estruturas inseridas](platform/embedded-frameworks.md)
...
#### [Noções básicas e configuração de compra no aplicativo](platform/in-app-purchasing/in-app-purchase-basics-and-configuration.md)
...
#### [Como adquirir produtos de consumo](platform/in-app-purchasing/purchasing-consumable-products.md)
#### [Como adquirir produtos não consumíveis](platform/in-app-purchasing/purchasing-non-consumable-products.md)
...
#### [Como implementar o SiriKit](platform/sirikit/implementing-sirikit.md)
...
##### [Passo a passo: Como usar notificações locais no Xamarin.iOS](platform/user-notifications/deprecated/local-notifications-in-ios-walkthrough.md)
...
### [Guia de Introdução](~/essentials/get-started.md?context=xamarin/ios)
...
### [Informações sobre o dispositivo](~/essentials/device-information.md?context=xamarin/ios)
...
### [Lanterna](~/essentials/flashlight.md?context=xamarin/ios)
...
### [Compartilhar](~/essentials/share.md?context=xamarin/ios)
...
#### [Guia de Introdução](~/cross-platform/data-cloud/active-directory/get-started/index.md?context=xamarin/ios)
##### [Etapa 1. Registro](~/cross-platform/data-cloud/active-directory/get-started/register.md?context=xamarin/ios)
...
##### [Como configurar um aplicativo no iTunes Connect](deploy-test/app-distribution/app-store-distribution/itunesconnect.md)
...
#### [Suporte IPA](deploy-test/app-distribution/ipa-support.md)
...
### [Como compilar para dispositivos diferentes](deploy-test/compiling-for-different-devices.md)
### [Ambiente](deploy-test/environment.md)
### [Mecânica de build do iOS](deploy-test/ios-build-mechanics.md)
...
### [Teste de unidade](deploy-test/touch.unit.md)
...
### [Passo a passo: Como usar a ferramenta Instruments da Apple](deploy-test/walkthrough-apples-instrument.md)
### [Desempenho](deploy-test/performance.md)
### [Solução de problemas](deploy-test/troubleshooting.md)
## [Plataforma Apple](~/cross-platform/macios/index.md?context=xamarin/ios)
...
#### [Visão geral](~/cross-platform/macios/unified/overview.md?context=xamarin/ios)
...
#### [Associação de bibliotecas Objective-C](~/cross-platform/macios/binding/objective-c-libraries.md?context=xamarin/ios)
...
##### [Guia de Introdução](~/cross-platform/macios/binding/objective-sharpie/get-started.md?context=xamarin/ios)
...
### [Referências nativas](~/cross-platform/macios/native-references.md?context=xamarin/ios)
...
### [Trabalhando com tipos nativos em aplicativos multiplataforma](~/cross-platform/macios/native-types-cross-platform.md?context=xamarin/ios)
...
### [Regras de Análise do Xamarin.iOS](troubleshooting/xamarin-ios-analysis.md)
### [Mensagens de erro (mtouch)](troubleshooting/mtouch-errors.md)
### [Perguntas frequentes](troubleshooting/questions/index.md)
#### [Como depurar com o Xcode](troubleshooting/questions/debugging-with-xcode.md)
#### [Posso usar uma VM de Mac com o Xamarin?](troubleshooting/questions/mac-vm.md)
#### [Como baixar uma versão anterior do Xcode](troubleshooting/questions/previous-xcode.md)
...
#### [Por que o envio do meu aplicativo falha com: "Caminhos não permitidos ( "iTunesMetadata.plist" ) encontrados em..."?](troubleshooting/questions/itunesmetadata-disallowed-paths.md)
...
#### [Por que meu aplicativo iOS 9 falha com: System.Exception: Falha ao realizar marshaling do objeto Objective-C?](troubleshooting/questions/exception-marshal-obj-c.md)
#### [Erro de tempo de execução: O assembly mscorlib. dll não foi encontrado ou não pôde ser carregado](troubleshooting/questions/error-mscorlib-not-found.md)
#### [O arquivo IPA tem 0 bytes](troubleshooting/questions/ipa-zero-bytes.md)
#### [Erro de IBTool: Não foi possível concluir a operação.](troubleshooting/questions/error-ibtool.md)
#### [Erro de MT1009: Não foi possível copiar o assembly](troubleshooting/questions/error-mt1009.md)
...
### [Guia de Introdução](watchos/get-started/index.md)
#### [Introdução ao watchOS 5](watchos/get-started/intro-to-watchos.md)
...
## [tvOS](tvos/index.md)
### [Guia de Introdução](tvos/get-started/index.md)
#### [Como instalar o suporte de tvOS](tvos/get-started/installation.md)
...
#### [Como trabalhar com ícones e imagens](tvos/app-fundamentals/icons-images.md)
#### [Como trabalhar com navegação e foco](tvos/app-fundamentals/navigation-focus.md)
#### [Armazenamento de dados e recursos](tvos/app-fundamentals/resources-data-storage.md)
#### [Como reproduzir sons com AVAudioPlayer](tvos/app-fundamentals/sounds.md)
...
#### [Exibições de tabela](tvos/user-interface/table-views.md)
...
##### [Como publicar na Apple TV App Store](tvos/deploy-test/app-distribution/app-store-publishing.md)
...
## [Notas sobre a versão](https://docs.microsoft.com/xamarin/ios/release-notes/)
## [Exemplos](samples/index.yml)
