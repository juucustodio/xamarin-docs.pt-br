...
##### [Passo a passo: local em segundo plano](app-fundamentals/backgrounding/ios-backgrounding-walkthroughs/location-walkthrough.md)
...
#### [Passo a passo: como usar o Touch no iOS](app-fundamentals/touch/ios-touch-walkthrough.md)
...
#### [Passo a passo: elementos gráficos e animação](platform/graphics-animation-ios/graphics-animation-walkthrough.md)
...
### [Potência](~/essentials/power.md?context=xamarin/ios)
...
#### [Passo a passo: como trabalhar com o WCF](~/cross-platform/data-cloud/web-services/walkthrough-working-with-wcf.md?context=xamarin/ios)
