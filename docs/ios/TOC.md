...
#### [Passo a passo: como trabalhar com WCF](~/cross-platform/data-cloud/web-services/walkthrough-working-with-wcf.md?context=xamarin/ios)
...
### [Pilha de HttpClient e seletor de implementação SSL/TLS](~/cross-platform/macios/http-stack.md?context=xamarin/ios)
