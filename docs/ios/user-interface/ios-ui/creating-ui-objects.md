---
title: Criando objetos de Interface do usuário no xamarin
description: Este documento fornece uma visão geral de como criar uma interface do usuário em xamarin. Ele aborda o iOS Designer, Xcode Interface Builder, c# e storyboards.
ms.prod: xamarin
...
ms.locfileid: "34790146"
---
# <a name="creating-user-interface-objects-in-xamarinios"></a>Criando objetos de Interface do usuário no xamarin
