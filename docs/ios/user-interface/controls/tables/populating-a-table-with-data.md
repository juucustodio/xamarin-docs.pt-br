---
title: Populando uma tabela com dados em xamarin
description: Este documento descreve como preencher uma tabela com dados em um aplicativo xamarin. Ele discute UITableViewSource, reutilização de célula, a adição de um índice e cabeçalhos e rodapés.
ms.prod: xamarin
...
ms.locfileid: "34790062"
---
# <a name="populating-a-table-with-data-in-xamarinios"></a>Populando uma tabela com dados em xamarin
