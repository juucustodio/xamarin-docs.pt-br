...
> [!IMPORTANT]
> `UISearchController` foi implementado no iOS 8. Se você deseja oferecer suporte a dispositivos anteriores a isso, você precisará usar `UISearchDisplayController`.
