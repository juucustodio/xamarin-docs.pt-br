...
2. Expanda o `NSExtension` chave.
3. Adicione a `UNNotificationExtensionCategory` chave como tipo **cadeia de caracteres** com o valor da categoria de extensão pertence a (neste exemplo ' convite de evento): 
