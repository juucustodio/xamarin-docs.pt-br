...
Para obter mais informações, consulte da Apple [Local e o guia de programação de notificação remota](https://developer.apple.com/documentation/usernotifications) documentação.
