---
title: Gráficos de núcleo no xamarin
...
ms.locfileid: "34786750"
---
# <a name="core-graphics-in-xamarinios"></a>Gráficos de núcleo no xamarin
...
> [!IMPORTANT]
> Altera para o contexto de gráficos se aplicam a todas as operações de desenho subsequentes. Portanto, quando o CTM é transformado, isso afetará qualquer desenho adicional. Por exemplo, se você desenhou o triângulo após a transformação CTM, parece cabeça para baixo.
