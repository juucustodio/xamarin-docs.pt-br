---
title: Introdução ao CoreML em xamarin
description: Este documento descreve CoreML, que permite que o aprendizado de máquina no iOS. Este documento descreve como começar com CoreML e como usá-lo com o framework de visão.
ms.prod: xamarin
