...
Em seguida, você deve calcular os hashes para cada arquivo e criar o `manifest.json` arquivo. Ele terá uma aparência semelhante a esta quando você terminar:
