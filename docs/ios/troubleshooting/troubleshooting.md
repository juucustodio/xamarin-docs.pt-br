...
Anexe os logs de XS **~/Library/Logs/XamarinStudio-{VERSION}/Ide-{TIMESTAMP}.log**, **AndroidTools-{TIMESTAMP}. log**, e * * componentes-{TIMESTAMP}. log * * (em versões mais antigas de XS / MonoDevelop, basta enviar **~/Library/Logs/MonoDevelop-(3.0|2.8|2.6)/MonoDevelop.log**).
