...
## <a name="unhandled-exception-systemexception-failed-to-find-selector-someselector-on-type"></a>Exceção sem tratamento: Exception: Falha ao localizar o seletor someSelector: em {type}
