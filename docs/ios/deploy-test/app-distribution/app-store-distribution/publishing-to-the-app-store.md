...
1. Selecione **Opções de IPA do iOS > Configuração > Ad Hoc** (se **Ad Hoc** não for uma opção, selecione **Versão**) e marque a caixa de seleção para compilar um arquivo IPA:
