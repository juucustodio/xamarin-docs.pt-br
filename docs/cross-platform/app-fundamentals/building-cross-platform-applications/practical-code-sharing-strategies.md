...
description: Este documento aborda prático código compartilhamento estratégias para cenários como acesso a arquivos, bancos de dados, operações de rede e código assíncrono.
ms.prod: xamarin
