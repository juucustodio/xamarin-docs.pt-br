...
description: Este documento descreve como manipular divergência de aplicativo com base na plataforma ou recurso. Ele aborda o tamanho da tela, metáforas de navegação, toque e gestos, notificações por push e paradigmas de interface, como listas e guias.
ms.prod: xamarin
