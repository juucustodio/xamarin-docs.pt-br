...
Essas capturas de tela mostram os designers visuais tela disponíveis em cada plataforma:
 ...
 [ ![](understanding-the-xamarin-mobile-platform-images/designer-all1.png "Essas capturas de tela mostram os designers visuais tela disponíveis em cada plataforma")](understanding-the-xamarin-mobile-platform-images/designer-all1.png#lightbox)
...
-   **Windows** – [diretrizes de Design de experiência do usuário do Windows](https://developer.microsoft.com/windows/design)
