...
|[Ai3](http://www.ai3online.com)|Atlanta, Geórgia|o AI3 é uma equipe entre as disciplinares, arquitetos, artistas e os pesquisadores que fornecem a cada cliente um processo de design agradável, proposital e inspirador|
...
|[Laboratórios digitais CIE](http://www.ciedigital.com/)|Los Angeles, EUA; Irvine, EUA|O CIE digital Labs é apaixonado por entender os desafios de negócios que nossos parceiros enfrentam e inovação novas soluções de software que trazem valor empresarial meditivo|
...
|[Sistemas EPAM](https://www.epam.com)|Newtown, PA; Cidade de Nova York; Filadélfia Chicago São Francisco; Los Angeles; Londres Minsk São Petersburgo; Budapeste|A EPAM Systems, Inc é uma empresa líder em desenvolvimento global de produtos e serviços de engenharia de plataforma digital|
...
|[Kaonsoft](http://www.kaonsoft.net/)|Palo Alto, CA, EUA; Chicago, IL, EUA; Caramba, OH, EUA; Seongnam-si, Gyeonggi, Coreia do Sul|O Kaonsoft é uma empresa de software inovadora que fornece soluções completas de ponta a ponta para criar aplicativos de mobilidade empresarial para plataformas cruzadas.|
...
|[Mooseworks software](http://mooseworkssoftware.com/)|Dublin, NH |O Mooseworks software foi iniciado em 2003. Nós especializadamos no mercado móvel antes que o celular fosse legal. Nesse momento, nós vendemos controles para desenvolvedores que criaram aplicativos com centenas de milhares de usuários finais. W|
...
|[SPAN Infotech Índia Pvt. Ltd.](http://www.spansystems.com)|Bangalore, Índia; Irving, TX|O SPAN afeta os negócios do cliente por meio do uso ideal de conhecimento de domínio, conhecimento tecnológico e modelos robustos de envolvimento. Os clientes recebem um grande valor de sua abordagem pragmática para um envolvimento, em vez de um modelo baseado em custo ou puramente controlado por processos. A equipe de gerenciamento do SPAN está profundamente envolvida em relações de manutenção por meio do cumprimento de expectativas mensuráveis e intangíveis.|
...
|[Technossus](http://www.technossus.com/)|Irvine, CA, EUA|O Technossus é uma empresa de consultoria em tecnologia e soluções de software premiadas em particular. Fundada aproximadamente uma década atrás por especialistas do setor, ajudamos as empresas a projetar, desenvolver e implementar soluções de software inovadoras. Nossos principais valores, incluem o compromisso de fornecer valor e qualidade excepcionais para cada &ndash; cliente toda vez. Superamos as expectativas e fornecemos soluções que transformam as empresas e aprimoram o desempenho operacional de maneira econômica.|
...
|[Parceiros do Monroe ocidental](http://www.westmonroepartners.com)|América do Norte, Europa, América Latina e além.|A equipe do West Monroe Partners é composta por uma combinação incomum de consultores de negócios experientes e especialistas técnicos que trabalham juntos para obter um sucesso sustentável.|
...
|[Orbital8](http://www.orbital8.com.au)|Melbourne, Austrália|Orbital8 são especialistas no desenvolvimento de software manual para plataformas empresariais, Web e móveis. Nosso foco está constantemente em fornecer soluções de software inovadoras, mas simples e econômicas, que fornecem valor comercial real aos nossos clientes. Nós nos orgulhamos de poder interpretar e prever as necessidades de nossos clientes e fornecer uma solução que exceda suas expectativas. |
|[Soluções puras](http://www.puresolutions-online.com/Home)|Sydney NSW, Austrália|Uma equipe confirmada de especialistas em seus respectivos campos apaixonados por criar as melhores soluções por meio da fusão de negócios e tecnologia.|
|[Readify](http://readify.net)|Docklands, VIC 3008 Austrália|O Readify atingiu o reconhecimento global para sua capacidade de ajudar os clientes a criarem software que conduza a colaboração, a produtividade, o crescimento dos negócios e a lucratividade. Sua capacidade de ajudar os clientes é um resultado direto de aplicar os processos de desenvolvimento de software de práticas recomendadas e empregar os desenvolvedores de elite. Eles fazem isso por meio de um processo de recrutamento rigoroso e controlado por pares e, em seguida, continuam a investir no desenvolvimento de suas pessoas, garantindo que suas habilidades permaneçam no Forefront do conhecimento do setor.|

## <a name="belgium"></a>Bélgica

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[3factr](http://3factr.be/)|Edegem, Bélgica|o 3factr é 100% voltado para o desenvolvimento móvel do Xamarin com integrações de API de drivers. Theyprovide consultoria como o desenvolvimento interno da fábrica de software de aplicativos Xamarin iOS, Android e UWP.|
|[CaveBirdLabs](http://www.cavebirdlabs.com/)|Antuérpia, Bélgica|O CaveBirdLabs é um Mobile Development Studio baseado na Bélgica que se concentra em desenvolver um lindo aplicativo móvel interativo|
...
|[CVBA de pilotos de fluxo](http://www.flowpilots.com)|Antuérpia, Bélgica|O Flow Pilots projeta, compila, implanta e gerencia as ferramentas digitais que ajudam seus clientes a aumentarem as receitas, diminuir os custos ou trazer liberdade e flexibilidade para seus funcionários.|
|[KENZE](http://www.kenze.be)|Mechelen, Bélgica|Microsoft .NET projeto en gerelateerde technologieën.  De Drie belangrijkste pijlers Binnen de Organisatie zijn mensaly, Kennis en mensenkennis, desejam Zij vormen de base voor kwalitatieve, succesvolle Project to en tevreden Klanten. |
|[Levelapp](http://www.levelapp.be)|Hoeilaart, Bélgica|Estamos Levelappndo uma agência móvel completa. Estamos agindo como desenvolvedores de software. Criamos aplicativos de plataformas cruzadas que se ajustam e lançar sua visão estratégica. fornecemos valor para seus clientes, parceiros e funcionários. |
|[Realdolmen](http://www.realdolmen.com/)|Huizingen, Bélgica; Kontich, Bélgica; Lummen, Bélgica; Ghent, Bélgica; Harelbeke, Bélgica; Namur, Bélgica; Mons, Bélgica|O Mobile é o novo padrão. Quase todas as empresas precisam de serviços móveis ou aplicativos para permanecerem competitivas. Mas uma estratégia móvel por si só não é suficiente; Tudo precisa estar totalmente integrado à sua infraestrutura geral de ICT, incluindo a nuvem, a segurança, o ERP e assim por diante. Em RealDolmen, chamamos isso de um negócio conectado.|

## <a name="brazil"></a>Brasil

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Grupo Viceri](http://www.viceri.com.br)|Jundiaí, Brasil|Fornecemos serviços de Web, desenvolvimento de aplicativos móveis e business intelligence|
|[Soluções superativas](http://www.superactive.com.br/)|Brasil|Um superativo é uma empresa especializada em desenvolvimento de soluções tecnológicas inovadoras com foco na TI estratégica, otimizando processos, de forma a fornecer resultados rápidos e seguros para os clientes seus. |

## <a name="canada"></a>Canadá

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Apcurium](http://www.apcurium.com)|Montreal, Canadá|O Apcurium desenvolve soluções móveis que se conectam a dispositivos móveis, plataformas e tecnologias atuais, com estratégias de negócios e expectativas de usuários específicas.|
|[BSI Labs](https://bsilabs.ca/)|Toronto, Canadá|O BSI Labs é uma consultoria de serviço completo especializada em estratégia móvel, design de interface do usuário/UX, desenvolvimento de aplicativos móveis e integração de sistemas.|
|[Clearbridge Mobile](https://clearbridgemobile.com/)|Toronto, Canadá|O Clearbridge Mobile é uma empresa de desenvolvimento de aplicativo móvel de pilha completa premiada que fornece serviços de design e engenharia de produtos centrados no usuário|
|[Cognitiva X Solutions Inc.](http://cognitivex.com)|Moncton, Canadá|Criamos experiências Web e móveis |
|[Mídia Cortex](http://cortex.bz)|Quebec, Canadá|O Cortex Media projeta plataformas móveis que conectam o real e os negócios, as empresas e as pessoas|
|[Formatec](http://mobile.formatec.ca)|Halifax, Nova Escócia, Canadá|O Formatec é uma empresa canadense de retenção de programas que é especializada na criação e no teste de aplicativos de software executados em dispositivos móveis, incluindo Smart Phones e tablets|
|[nventive](http://www.nventive.com)|Montreal, QC|o nventive é um estúdio moderno que desenvolve aplicativos móveis para iOS, Android e Windows 10 usando as tecnologias mais recentes.|
|[ObjectSharp Corporation](http://www.objectsharp.com)|Toronto, Canadá|Como o primeiro parceiro de consultoria Microsoft .NET no Canadá, o ObjectSharp pode oferecer uma gama completa de serviços personalizados de desenvolvimento, treinamento e aconselhamento da Microsoft para: PC e Tablet, Windows 8 + Windows 7, telefone, Windows Phone, nuvem e Azure. Seus MVPs da Microsoft, desenvolvedores de software sênior e treinadores experientes ajudarão você a projetar, criar e entregar aplicativos melhor e rápido.|
...
| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Datatech I.T. Soluções LTD](http://www.datatech.com.cy)|Chipre|Datatech I.T. A Solutions Ltd é um provedor líder de soluções de tecnologia nos campos de gerenciamento de conteúdo corporativo, gerenciamento de cadeia de fornecedores e soluções móveis|
...
| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Bureauet do aplicativo](https://appbureauet.dk/)|Svendborg, Dinamarca|O aplicativo Bureauet é uma empresa de desenvolvimento de aplicativos|
|[Bluefragments](http://www.bluefragments.com)|Copenhague, Dinamarca|O Bluefragments é especialista em desenvolvimento de aplicativos e é um parceiro certificado da Microsoft.|
|[ApS Comet.dk (CometPeople)](http://comet.dk)|Copenhague, Dinamarca|Comet é uma casa de desenvolvimento que oferece o desenvolvimento de aplicativos móveis para as plataformas móveis mais recentes, como iPhone, iPad, Android e Windows Phone|
|[Comentário DK](http://commentor.dk)|Aalborg, Dinamarca|O comentário tem desde que 2000 forneceu aplicativos críticos para as maiores empresas da Dinamarca|
|[Miracle](https://miracle.dk/)|Ballerup, Dinamarca|Em Miracle, visamos fazer nossa contribuição para a digitalização da Dinamarca. Fazemos isso fornecendo soluções de ti de qualidade mais alta para empresas públicas e privadas de nossos três locais em volta da Dinamarca|

## <a name="dominican-republic"></a>República Dominicana

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Maven S.R.L.](http://www.maven.do)|República Dominicana|O Maven é uma pequena empresa com Big sonhos. Ele foi fundada em 2012 como uma maneira de oferecer soluções de software atualizadas, de alta qualidade e diversificadas na República Dominicana. Nós visamos fornecer aos nossos clientes a qualidade garantida do desenvolvimento de software e, ao fazer isso, promover uma relação de confiança e responsabilidade em direção às suas necessidades.|
|[Solvex Dominicanaa](http://www.solvex.com.do)||Experiência profissional de valores Solvexs. A empresa, estabelecida em 2014, agora tem 200 engenheiros de software de que mais de 80% têm 5 ou mais anos de experiência no fornecimento de software. |

## <a name="egypt"></a>Egito

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[ITWorx](http://www.itworx.com)|Cairo, Egito|ITWORX é uma empresa de serviços de ti global que fornece soluções locais e baseadas em nuvem para as principais organizações do mundo, com ênfase em análises avançadas, mobilidade corporativa, gerenciamento de desempenho e CRM.|
|[Desenvolvimento de Jios](https://www.jiosdev.com/)|Egito|O desenvolvimento de Jios é uma empresa estável e com crescimento rápido que fornece serviços de consultoria e terceirização de tecnologia especializado em desenvolvimento de aplicativos personalizados, serviços de nuvem e aplicativos móveis. |

## <a name="france"></a>França

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Da ontran França](http://www.altran.fr/)|Paris, França|A ontran é líder mundial em serviços de engenharia e R & D|
|[Arolla](http://www.arolla.fr/)|Paris, França|O Arolla é uma empresa de consultoria especializada nas técnicas mais avançadas de desenvolvimento de software.|
|[Cellenza](http://www.cellenza.com)|Paris, França|Cellenza é uma consultoria para experiência técnica e implementação, dedicada exclusivamente à tecnologia da Microsoft e aos métodos ágeis|
|[Chloro](http://www.chloro.eu)|Selestat, França|O chloro é especialista no design e no desenvolvimento de aplicativos móveis personalizados que visam proporcionar a você um lucro em produtividade e capacidade de resposta|
|[Grupo de DevoTeam](http://www.devoteam.com)|Paris, França|Em DEVOTEAM, fornecemos uma inovadora consultoria tecnológica para negócios|
|[Exakis](http://www.exakis.com)|Paris, França|O EXAKIS ajuda as empresas a desenvolver projetos inovadores e segurança do sistema de informações. Com foco no usuário, eles desenvolvem soluções baseadas em tecnologias da Microsoft que combinam design e inovação|
|[Ideine](http://ideine.fr/en/ideine/)|Roubaix, França|Especialista em desenvolvimento crossplatform, Ideine projeta e desenvolve aplicativos móveis personalizados, inovadores e eficientes.|
|[Quadrado infinito](http://www.infinitesquare.com)|Paris, França|A missão quadrada infinita é criar e produzir aplicativos de software inovadores e melhor qualidade em nome de seus clientes, empresas de grande e pequeno porte, na melhor relação de confiança e vencedoras em conjunto.|
|[Isiasoft](http://www.isiasoft.com/)|Paris, França; Lyon, França|O ISEO fornece amplo espectro de desenvolvimento de software e serviços consultacys|
|[La Mobile IT](http://www.la-mobile-it.com)|Grenoble, França|Nous sommes spécialisés depuis 10 ans dans le mobile et avons des relations étroites avec nos partenaires, client et fournisseurs pour tout ce qui touche à la mobilité. Nous n'avons aucune exclusivité, si vous désirez Pouvez des Conseils, Nous présenter une Solution ou Encore devenir partenaire, contactez-nous!|
|[Serviços Matellis](http://www.matelli.fr/english/)|Paris, França|Matelli é uma empresa de serviços de informações fundada em 2008 para criar aplicativos Web e móveis de negócios personalizados para seus clientes.|
|[Trabalhos mentals](http://www.mentalworks.fr)|Paris, França|Mentalworks é uma agência digital tecnológica atípicos: a agência de e-marketing da Web Agency e as empresas de consultoria/ESN. Essa experiência permite que eles criem sites, aplicativos móveis ou aplicativos de negócios personalizados e integrem soluções tecnológicas-chave.|
|[Aplicativos laranja para negócios](http://www.orange-business.com/en/contact-us)|Paris, França; Zurique, Suíça|O Orange Business Services é um operador global de telecomunicações e uma empresa de serviços de ti. Seus funcionários de 20.000 dão suporte a empresas, órgãos governamentais locais e organizações do setor público em todos os aspectos de sua transformação digital. Eles ajudam as empresas a colaborarem com mais eficiência, a operar com mais eficiência e &ndash; a se envolver melhor com seus clientes conectando suas pessoas, sites e computadores de forma segura e confiável.|
|[Page Up](http://www.pageup.fr)|Dijon, França||
|[Tecnologias Rayonnance](http://rayonnance.fr)|Paris, França|O grupo Rayonnance é um integrador de francês líder especializado em mais de 13 anos na implementação de aplicativos de rastreamento e de mobilidade no Windows terminal Business (Windows Mobile, Windows Phone 8,1, Windows 8), Android, IOS.|
|[SFEIR](http://www.sfeir.com)|Neuilly-sur-Seine, França; Strasbourg, França; Lille, França; Leudelange, Luxemburgo|SFEIR est une communauté façonnée par et pour des développeurs talentueux. Nous créons des Applications de Pointe et relevons avec nos clientes leurs défis técnicas Les e ambitieux.|
|[SOAT](http://www.soat.fr)|Paris, França|Nos últimos 15 anos, a SOAT cresceu uma comunidade de consultores e especialistas em tecnologias como Java-JEE, Microsoft, Web e Mobile em ambientes Agile. Eles dão suporte a seus clientes em suas opções de tecnologia, no design de sua arquitetura, na implementação e na evolução de suas informações, bem como em áreas de qualidade especial, como sua estratégia Web ou móvel, sua migração para computação em nuvem ou o realização de objetos conectados.|
|[Consultoria de Xiomega](http://www.xiomegaconsulting.com/)|Lyon, França|Estabelecida em 2014, a Xiomega Consulting é uma empresa de consultoria voltada para consultoria, gerenciamento de projetos e muito mais.|

## <a name="germany"></a>Alemanha

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[27interactive](http://27interactive.com)|Düsseldorf, Alemanha; Hamburgo, Alemanha|Soluções de plataforma cruzada adaptadas para smartphones e tablets com Android, iOS, Windows e macOS|
|[AIT](http://www.aitgmbh.de)|Stuttgart, Alemanha|A AIT é um dos desenvolvedores e consultores de software líderes especializados em plataformas .NET e muito mais. Ele tem sido um premiado Microsoft Gold Partner por muitos anos.|
|[Tudo sobre o Ashley GmbH](http://www.a-gentur.de)|Ibbenbueren, Alemanha|Tudo sobre o Ashley dá suporte a empresas no design e na otimização de soluções de ti.|
|[BRICKMAKERS GmbH](http://www.brickmakers.de)|Koblenz, Alemanha|Para todas as atividades de Brickmakers, o foco está no sucesso e no benefício do projeto. Devido à sua ação ágil durante seus processos, a transparência máxima para o cliente é fornecida. Além do conceito de intervalos, design e desenvolvimento, eles também assumem a responsabilidade por seus portais e marketing de aplicativos. Isso permite que eles reúnam todas as suas experiências no ciclo de vida completo de produtos digitais.|
|[AG BTC](http://www.btc-ag.com )|Oldenburg, Alemanha|Desenvolvemos novas soluções e especificamos o padrão para você|
|[CATIS](http://www.catis.de/)|Wolfsburg, Alemanha; Gifhorn, Alemanha; Hanover, Alemanha; Sindelfingen, Alemanha; Ingolstadt, Alemanha; Ajax, Canadá; Mlada Boleslav, República Tcheca; Chattanooga, TN|A unidade de trabalho moderna do CATIS tem uma equipe experiente de desenvolvedores de aplicativos, capaz de mobilisingr sua empresa criando aplicativos personalizados de negócios e consumidores|
|[Cayas Software](http://www.cayas.de)|Minden, Alemanha|O Cayas software cria software personalizado para a área de trabalho, aplicativos para Android, iPad e iPhone, bem como para a Web|
|[FRIDIE Interactive, Dietrich & Fritz GbR](http://fridie.de)|Stuttgart, Alemanha|Na FRIDIE Interactive, desenvolvemos aplicativos personalizados e softwares interativos para Windows, Android e iOS|
|[Incloud GmbH](https://www.incloud.de)|Darmstadt, Alemanha|A innuvem é uma empresa de software premiada, especializada em aplicativos e consultoria de plataforma cruzada empresarial|
...
|[Intelligentgraphics GmbH](http://www.intelligentgraphics.biz)|Thuringia, Alemanha|Nós nos concentramos em 3D interativo para aplicativos de vendas.|
|[ISEO online marketing GmbH](http://www.iseo.de)|Lübeck, Alemanha|Não entregamos o pino, mas fizemos o Tríade do valor do cliente, do design fantástico e da tecnologia comprovada para cada uso por mais de 10 anos|
|[sistemas de MSG AG](https://www.msg.group/travel-logistics/xamarin)|Berlim, Alemanha; Braunschweig, Alemanha; Brett, Alemanha; Chemnitz, Alemanha; Cologne (Köln), Alemanha; Essen, Alemanha; Frankfurt/M., Alemanha; Görlitz, Alemanha; Hamburgo, Alemanha; Hannover, Alemanha; Ingolstadt, Alemanha; Lingen (EMS), Alemanha; Münster, Alemanha; Nuremberg (Nürnberg), Alemanha; Passau, Alemanha; Schortens/Wilhelmshaven, Alemanha; St. Georgen, Alemanha; Stuttgart, Alemanha; Walldorf, Alemanha; Basel, Suíça; Viena (Wien), Áustria|MSG é um grupo internacional independente de empresas com mais de 7.000 funcionários em todo o mundo que oferecem um espectro de serviço holístico de consultoria criativa, estratégica e soluções de ti inteligentes, sustentáveis e de valor agregado para uma ampla gama de mercados.|
|[PRÓXIMA Munique GmbH](http://www.next-munich.com)|Munique, Alemanha|Seja B2C, B2B, produtividade ou outras estratégias móveis – o futuro das soluções móveis começa agora. O próximo Munique é aprofundado e lida sistematicamente com todos os ingredientes que contribuem para um ' aplicativo de negócios ' bem-sucedido. O próximo Munique coleta em todas as áreas de design e desenvolvimento, posicionamento e marketing de programas para dispositivos móveis usando 10 anos de experiência.|
|[prodot GmbH](https://prodot.de)|Duisburg, Alemanha|O Prodot compreende as visões de seus clientes; Eles trabalham juntos com você para mapear os resultados desejados. Interfaces de usuário intuitivas, designs elegantes, conhecimento tecnológico e verificação futura são elementos essenciais de suas soluções. Em ciclos curtos e eficientes, eles desenvolvem software estável, sofisticado e de longa duração para suas necessidades com base em tecnologias da Microsoft e produtos padrão, como SAP.|
|[AG SDX](http://www.sdx-ag.de)|Frankfurt, am Main, Hesse, Alemanha; Munique, Alemanha; Bavaria, Alemanha|Wir freuen uns, sie an unserem Neuen Hauptsitz im Frankfurter Westhafen begrüßen zu können. Unsere Büroräume se encontre sich im 2. OGON im Westhafenhaus, Speicherstraße 1, unmittelbar neben DEM Westhafentower.|
|[SkyTest](http://business.skytest.com)|Erlangen, Alemanha|Desenvolvemos aplicativos nativos personalizados e baseados na Web usando tecnologias de plataforma cruzada mais recentes, como o Xamarin™. Aproveite nossa experiência de longo prazo no. NET™ desenvolvimento e serviços de back-end avançados.|
|[Software2Business GmbH](http://software2business.de/Service/MobileApp/EN)||A Software2Business GmbH oferece um serviço completo abrangente para o desenvolvimento de seu aplicativo – e uma cooperação, que você vai gostar. Descubra o pipeline e as ferramentas de desenvolvimento que usamos. |
|[XITASO GmbH](http://www.xitaso.com)|Augsburg, Alemanha|O XITASO fornece serviços de consultoria para clientes B2B, identifica os potenciais de digitalização, otimiza os processos de negócios, cria estratégias digitais e desenvolve e oferece soluções de software inovadoras.|
|[Z √ € hlke](http://www.zuehlke.com/ch/en/)|Zurique, Suíça; Frankfurt, Alemanha; Hamburgo, Alemanha; Hannover, Alemanha; Munique, Alemanha; Stuttgart, Alemanha; Viena, Áustria|Desenvolvemos produtos, serviços e modelos de negócios com êxito financeira, desde a implementação até a implantação – desenhando a experiência de 1.000 especialistas internos e mais de 10.000 projetos bem-sucedidos.|

## <a name="greece"></a>Grécia

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[SA Entersoft](https://www.entersoft.eu)|Kallithea, Grécia|O Entersoft é um provedor de serviços e software de Entreprise de negócios líder que fornece serviços de alta qualidade inovadores e completos e suporte para garantir a eficiência otimizada para seus clientes|

## <a name="hong-kong"></a>Hong Kong

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Unissoft Technology Co. Ltd.](http://www.inas.online/en/Index.php)|Hong Kong|Nossa principal tecnologia por trás da Tsing Hua, o software de gerenciamento de arquivos (ou™ de AMS), foi o produto recomendado da administração de arquivos de estado da China por um longo tempo, portanto, também é amplamente usado pelo governo, vários setores, incluindo petróleo e química; em várias empresas, como trabalhos de irrigação, metallurgy, telecomunicações e imóveis---por meio do modelo de licenciamento local tradicional. |

## <a name="hungary"></a>Hungria

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Soluções de Grape](http://grape.hu/)|Budapeste, Hungria|Grape Solutions é uma empresa de desenvolvimento de software dinâmico estabelecida em 2006. Basicamente, desenvolvemos aplicativos de negócios personalizados para nossos clientes locais e internacionais. |

## <a name="india"></a>Índia

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[GAVS Technologies NA Inc.](http://www.gavstech.com)|Chennai, Índia|GAVS Technologies é um provedor de soluções de serviços de ti global & para clientes em vários verticais do setor|
|[Greynubo](http://www.greynubo.com/)|Cingapura Bengaluru, Índia|O GreyNubo inclui uma equipe de profissionais confirmados que têm muitos anos de experiência de domínio no CRM, CPQ, celular, juntamente com uma base sólida na plataforma Salesforce|
|[MobMaxime](http://www.mobmaxime.com)|Ahmedabad, Índia |Falaremos sobre a visão do produto e decideremos se você for um bom ajuste para seu projeto. Se estivermos, enviaremos uma estimativa de projeto para sua análise.|
|[Tecnologias Popup privadas limitadas](http://www.popuptechnologies.com)|Mumbai|As tecnologias pop-up surgiram 5 anos de volta e, desde então, foram um acessório no cenário móvel. Com sede em Mumbai, as tecnologias pop-up são uma empresa de soluções móveis que redetecta constantemente com novas tecnologias. Com um portfólio de mais de 100 aplicativos móveis em todas as plataformas – iOS, Android, Windows, Xamarin, Blackberry, HTML5, TIZEN e aplicativos Web progressivos.|
|[Tecnologias de comunicação Sasken limitadas](http://www.sasken.com)|Mumbai, Índia|O Sasken está ajudando as pessoas a se manterem mais bem conectadas onde quer que estejam. Mais setores, incluindo eletrônicos automáticos, eletrônicos de consumidores, varejo e saúde, estão vendo a conectividade com a nuvem como uma necessidade, juntamente com a tomada de decisões em tempo real e controlada por dados. Com competências de domínio inigualáveis no processamento de mídia e de comunicação, eles estão ajustados para tomar desafios críticos que o setor manifesta. Eles trabalham com suas contrapartes no ecossistema para fornecer serviços supremoss no novo ambiente em evolução de dispositivos conectados.|
|[ServPRO Technologies Pvt Ltd](http://www.servpro.in)|Mumbai, Índia|ServPRO, uma marca que representa "atendendo proativamente" foi fundada em 2009 por Sr. Pushpinder Bhatia. ServPRO é um provedor de serviços e soluções de ti líder dedicado a fornecer Comercialmente Crítico & soluções de ti inovadoras em vários segmentos verticais, incluindo o modo & garments, varejo, petróleo & gás, farmacêuticos, manufatura, setor bancário, agro, FMCG/CPG, Bull, EXIM e vários outros verticais do setor.|
|[Taritas Software Solutions Pvt. Ltd.](http://www.taritas.com/)|Bengaluru, Karnataka, Índia; Jabalpur, Madhya Andhra, Índia|O Taritas é uma empresa de terceirização de software que fornece soluções de ponta para muitos setores. O conhecimento abrangente do desenvolvimento de software e aplicativos combinado com os benefícios de custo no exterior nos permite fornecer serviços de desenvolvimento de alta qualidade, principalmente concentrados na minimização dos custos do projeto e na maximização do lucro de nossos clientes. Seguimos a abordagem "na primeira vez, na hora & no orçamento". |
|[Mahindra de tecnologia](https://techmahindra.com)|Bengaluru|O Tech Mahindra representa o mundo conectado, oferecendo serviços e soluções inovadores e voltados para o cliente, permitindo que as empresas, os associados e a sociedade crescem™. Somos uma empresa de US $4.400.000.000 com 117600 + profissionais em 90 países, ajudando mais de 840 + clientes globais, incluindo empresas da Fortune 500.|
|[TechAhead software Pvt. Ltd.](http://www.techaheadcorp.com)|Princeton, NJ; Noida, Índia|Estamos criando soluções de mobilidade que aceleram a transformação digital do local de trabalho, aumentam a produtividade, impõem a segurança e capacitam as pessoas a trabalharem de qualquer lugar, a qualquer momento. Desenvolva soluções de mobilidade de melhor ajuste para seu modelo corporativo e metas de negócios que repercussão perfeitamente com a percepção da marca, a penetração do mercado, a integração de serviços e as expectativas dos clientes.|
|[Serviços de consultoria em árvore de movimentação](http://www.walkingtree.in/)|Hyderabad, Índia|A árvore de movimentação é um software de ti e um provedor de serviços reconhecidos por sua paixão pela tecnologia. Eles atuam como equipe de desenvolvimento de produtos ou equipe de engenharia de back-end para clientes em todo o mundo.|
|[Web Spiders](http://www.webspiders.com)|Nova York, NY; Londres, Reino Unido; Cingapura Índia|O Web aranhas (webspiders) é uma empresa de software empresarial que desenvolve produtos para marketing e RH para impulsionar o ' engajamento do usuário ' para avançar usando mobilidade e bots de inteligência artificial.|

## <a name="ireland"></a>Irlanda

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Tecnologia Greenfinch](https://greenfinch.ie/)|Dublin, Irlanda|A empresa de engenharia de software se concentrou na inovação & qualidade. Fornecemos aos nossos clientes um design, & o serviço de gerenciamento para ajudá-los a enfrentar os desafios de seus negócios no mundo atual de mudanças rápidas|

## <a name="italy"></a>Itália

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Cortis Lentini](http://www.cortislentini.com)|Milão, Itália; Roma, Itália; Bergamo; Itália|Cortis Lentini provicemente a infraestrutura inovadora e os serviços técnicos oursourcings|
|[Dataexpert S.r.l.](http://www.dataexpert.it)|Milão, Itália|O dataexpert é líder em fornecer serviços de ti com um alto valor inovador, orientado a serviços, fácil de integrar com infraestruturas de tecnologia existentes, implementação rápida e simples|
|[Mente de fábrica](http://www.factorymind.com)|Trento, Itália|A mente de fábrica é uma cooperativa jovem e dinâmica que consiste em uma equipe de desenvolvedores apaixonados, com um lançamento para ciência da computação, tecnologia e inovação.|
|[Quinto INGenium](https://fifthingenium.com/)|Milão, Itália|FifthIngenium é uma empresa de ti em italiano especializada em aplicativos móveis, soluções de nuvem e tecnologias emergentes|
|[Gaia S.r.l.](http://www.gaia.is.it/en/)|Milão, Itália|Gaia é uma empresa de design de experiência que cria ecossistemas digitais projetados para pessoas.|
|[Giuneco s.r.l.](http://www.giuneco.it/)|Florence, Itália|A missão da empresa é explorar novas tecnologias (principalmente relacionadas ao mundo da Microsoft) para criar soluções eficazes e eficientes com uma atenção considerável de usabilidade (UX) e capacidade de manutenção|
|[Lemcube](http://www.lemcube.com)|Paese, Treviso, Itália|Empresa de consultoria com 10 anos de experiência com o Microsoft .net. Nossos clientes são indústrias, logística, manutenção e mobilidade. Podemos oferecer treinamentos e treinos sobre o trabalho.|
|[Srl Mahiz](http://www.mahiz.it/)|Itália|ARTISANS de software, a Mahiz ajuda as empresas a criar melhores produtos, oferecendo vinte anos de experiência no campo de tecnologia da informação. Sua missão é livrar o mundo de software insatisfatório que bloqueia a evolução do produto, dos processos e das ideias. |
|[Proge-software](http://www.progesoftware.com)|Roma, Itália; Milão, Itália|Estamos produzindo projetos com um conteúdo altamente tecnológico para empresas de grande e médio porte, tanto nacionalmente quanto internacionalmente, desde 1985. Fornecemos todas as atividades necessárias para o design, o desenvolvimento e a manutenção do sistema de ti corporativo|
|[O PS Mobile Srl](http://www.psmobile.it)|Bologna, Itália|A filosofia do PS Mobile se baseia na caixa de diálogo; ouvir o cliente e, juntos, definir uma estratégia. Para que isso seja bem-sucedido, é essencial reconciliar as necessidades de usuários, as metas de negócios e as possibilidades oferecidas pelas plataformas. Sua equipe de desenvolvimento fornece excelente desempenho em termos de elementos gráficos, tecnologia e experiência do usuário, e leva em conta os aspectos específicos da plataforma escolhida.|
|[SNC SOFOS](http://www.sofos.it )|Bologna, cidade metropolitana da Bologna, Itália||

## <a name="japan"></a>Japão

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Fenrir Inc.](http://www.fenrir-inc.com/)|Osaka, Japão; Tóquio, Japão; Nagoya, Japão|O Fenrir desenvolve aplicativos Web e móveis para iOS, Android e Windows |

## <a name="latvia"></a>Letônia

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Empresas diatoms](http://www.diatomenterprises.com/)|Riga, Letônia|Desenvolvemos sistemas Web, móveis e de desktop individuais que capitalizam a força da sua individualidade de negócios de clientes|
...
|[DigiPresence](http://www.digipresence.net)|Dubai, Emirados Árabes Unidos|A presença de Digi fornece, instala e fornece serviços de manutenção e suporte técnico para a Directorate geral de Assuntos Estrangeiros de residência-Dubai e seus centros estrangeiros.|
|[TechSource LLC](http://www.techsource.ae/)|Dubai-Emirados Árabes Unidos|Nossos serviços variam desde desenvolvimento e manutenção de aplicativos, soluções de integração até ERP, CRM e serviços de consultoria funcional. Nos últimos anos, fornecemos melhorias significativas de desempenho para líderes de mercado no Oriente Médio.|

## <a name="netherlands"></a>Países Baixos

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Especialistas em Caesar](http://www.caesarexperts.nl/)|Utrecht, Países Baixos|Os especialistas em Caesar projetam, compilam, implementam e gerenciam soluções de ICT poderosas e inovadoras.|
|[Dalosy](https://dalosy.com)|Hendrik-ido-Ambacht, Países Baixos| O Dalosy fornece soluções móveis que atendem às necessidades e aos desafios específicos de várias empresas e indústrias|
|[Elastique](https://www.elastique.nl/)|Hilversum, Países Baixos|Elastique é uma empresa de desenvolvimento de aplicativos inovadora|
|[EsperantoXL](http://www.esperantoxl.nl)|Utrecht, Países Baixos|EsperantoXL specialises no desenvolvimento de soluções de software inteligente. Ajudamos as organizações a melhorar sua eficiência simplificando seus processos|
|[Finaps](https://www.finaps.nl/)|Amsterdã, Países Baixos|O Finaps fornece soluções de ti inovadoras usando tecnologias avançadas, como Mendix, SAS, Xamarin e box.|
|[Liberado](http://www.freed.nl/)|Achtkarspelen, Países Baixos|O liberou desenvolve aplicativos Web e móveis para iOS, Android e Windows |
|[Holygrow](http://www.holygrow.nl )|Capelle aan sala IJssel, Países Baixos|Com nossa criatividade, conhecimento, experiência e paixão, criamos produtos digitais significativos. Fazemos isso com as quatro seguintes acreditadas.|
|[Soluções de Internet de pulsos](http://www.i-pulse.nl)|Doetinchem, Países Baixos|O I-Pulse compila software personalizado na Web, no aplicativo e muito mais|
|[Consultores de Ijsberg](http://www.ijsbergconsultants.nl)|Amsterdã, Países Baixos|Se ele se preocupa com design de negócios, estratégia, inovação, desenvolvimento de produtos, orientação do cliente ou comunicação, o IJsberg ajuda as organizações a fazer o Excel. Fazemos isso formular uma abordagem integrada completa|
|[B.V. de suporte de informações](http://www.infosupport.com)|Veenendaal, Holanda; Mechelen, Bélgica|O suporte a informações é um especialista no desenvolvimento, gerenciamento e Hospedagem de software personalizado e fornecimento de soluções de BI e integração|
|[iQuality](http://www.iquality.nl)|Nijmegen, Países Baixos|Projetamos, desenvolvemos e damos suporte a software, aplicativos e sites com base no ambições de nossos clientes. |
|[KEMBIT B.V.](http://www.kembit.nl/)|Wijnandsrade, Países Baixos|Graças à antecipação de desenvolvimentos monitorados e às necessidades resultantes, apresentamos e percebemos as soluções de ti apropriadas, qualitativas, inovadoras e inteligentes.|
|[Consultoria de KPN](https://www.kpnconsulting.nl/)|Zoetermeer, Países Baixos|A visão do KPN é que é muito mais do que a implantação da tecnologia. Aumentar a vigor dos seres humanos e da organização é sua prioridade.|
|[Logirix](http://www.logirix.com/en/)|Groningen, Groningen|O Logirix fornece interfaces funcionais e amigáveis, que conectam os usuários finais às necessidades dos dados e processos organizacionais|
|[Macaw Nederland](http://www.macaw.nl)|Schiphol-Rijk, Holanda; Barendrecht, Holanda; Apeldoorn, Países Baixos|O Macaw projeta, cria e gerencia soluções de tecnologia digital para celular, online, escritório e Home. Eles são especialistas no campo de integração de negócios, colaboração social, nuvem, automação de marketing, análise de negócios e terceirização.|
|[Nova ligação móvel](http://www.newnexusmobile.nl)|BW, Amsterdã|Novas soluções móveis de Nexus criam aplicativos de negócios e de consumidor para todas as plataformas. Novas soluções móveis de nexus orientam as organizações durante todo o processo: desde a consultoria até a realização e da implementação até a manutenção.|
|[Open Circle Solutions B.V.](http://www.opencirclesolutions.nl/en/)|Eindhoven, Países Baixos|As soluções de círculo aberto têm uma missão de tornar as pessoas e os clientes bem-sucedidos, por meio de conhecimento e inovação. Eles agem com isso e usam tecnologia de software livre para: aplicativos de negócios, aplicativos móveis, integração, business intelligence e desenvolvimento de produtos. Eles acreditam que em soluções personalizadas fornecidas por uma abordagem ágil/SCRUM supervisionada pelos gerentes de projeto que trabalham principalmente seguindo o método PRINCe2.|
|[Ordina ICT](https://www.ordina.com)|Nieuwegein, Holanda; Groningen, Holanda; Amsterdã, Países Baixos; Eindhoven, Holanda; Apeldoorn, Países Baixos|A Ordina alcança sua missão gerando inovações sustentáveis em parceria com seus clientes. Eles obtêm isso forjando relacionamentos próximos com seus clientes. Eles começam com investimentos em confiança e compreensão recíprocas. Mas isso é apenas o começo; Eles querem fornecer soluções sustentáveis que realmente ajudam as pessoas a avançar. Projetos e programas desenvolvidos sem desperdiçar horas e recursos Man, que fazem o que eles devem fazer e são fáceis de gerenciar, o que, por sua vez, significa que eles têm uma vida útil longa.|
|[Ponto 42](http://www.point42.nl)|Reeuwijk, Países Baixos|Smartphones en tablets Halen de gewone computador na rap tempo em último aantal Gebruikers. Uitstekende gebruikservaring op mobiele apparaten é hierdoor belangrijker dan Ooit. Ponto 42 werkt Altijd vanuit rde Mobile-en Cloud-First gedachte en spitst zijn dienstverlening Toe op responsive webdesign.|
|[BV de círculo rápido](http://www.rapidcircle.com/)|Amsterdã, Países Baixos; Pune, Índia; Melbourne, Austrália|De digitale werkplek é de vervanger van het bureaublad op de PC. De variante online é Echter Altijd beschikbaar, ook op mobiele apparaten. Voor de (mobiele) digitale werkplek Enrollment de Standaard a van Office 365 UIT. |
|[Redhotminute](http://www.redhotminute.com)|Tuil, Países Baixos||
|[Rubicon](http://www.rubicon.nl/diensten/mobiele-apps)|Postbus 169, 4130 ED Vianen|Van Visie Transp Strategie, design Transp app-Development, Integratie atendia a ERP, teste, Beheer en Cloud. Wij hebben Kennis Van en ervaring atendido Het Bouwen Van mobiele oplossingen Die passe bij UW individuele behoeften en Kansen. Rubicon ontwerpt, ontwikkelt, teste, implantou aplicativos do beheert. Cumpriu o onze ' Mobile DevOps-Aanpak ' zorgen voor rde voorspelbare, betrouwbare en inzichtelijke ontwikkel-en beheeraanpak voor UW.|
|[Versluis](https://gerald.verslu.is/)|Sittard, Países Baixos|No momento, estou principalmente me concentrando na criação de aplicativos, especialmente por meio do Xamarin e tudo o que tem a ver com ele. Mas um aplicativo não está completo sem um back-end adequado, certo? Portanto, não tenho medo de algum ASP.NET (núcleo) ou outros aplicativos Web. Também gosto de se ajustar com todos os tipos de outras coisas, como: entrega contínua e integração contínua, tudo o que o Azure,|
|[Xablu](http://www.xablu.com/)|Amsterdã, Países Baixos|Potencialize sua equipe de desenvolvimento de aplicativos com soluções de desenvolvimento de aplicativos Xamarin, desde montar equipes de desenvolvimento e terceirizar para criar ambientes de desenvolvimento padrão do setor.|
|[Xpirit Nederland B.V.](https://xpirit.com)|Hilversum, Países Baixos|Profissionais de tecnologia apaixonados, dispostos e capazes de fazer coisas de forma diferente. Xpirit são inovadores, habilitadores de transformação e pioneiros que adotam alterações. Especialistas em novas tecnologias da Microsoft.|

## <a name="new-zealand"></a>Nova Zelândia

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Designs de esclarecimentos](https://www.enlighten.co.nz)|Auckland, Nova Zelândia|O esclarecimento existe para trazer soluções de tecnologia desenvolvidas, inovadoras e orientadas a clientes para o mundo. Eles usam tecnologias da Microsoft para criar um aplicativo C# no para IOS, Android e Windows|
|[Hydrogen aplicativos Ltd](http://www.hydrogenapps.com)|Auckland, Nova Zelândia|Ao aproveitar uma década de experiência oferecendo com êxito plataformas de grande escala em todo o mundo, o Hydrogen traz sua ampla experiência de entrega de software pendente para a nova idade de aplicativos, mobilidade e desenvolvimento de jogos|
|[Magnetism Solutions Ltd](https://www.magnetismsolutions.com/)|Auckland, Nova Zelândia; Christchurch, Nova Zelândia|Obtemos um lançamento de todas as implementações de CRM que fornecemos aos nossos clientes. Tendo iniciado com êxito mais de 1500 deles, estamos muito orgulhosos de nosso portfólio diversificado e amplo. Nossa experiência em implementar o CRM internacionalmente significa que estamos bem posicionados para fornecer sua solução de CRM. |
|[Cruzamento de pretas](http://zebracrossing.co.nz/)|Taranaki, Nova Zelândia|Usamos tecnologia para inovação nos negócios. Parceiro com alguém que vai ouvir você, aprender suas metas e fornecer o que você precisa.|
...
| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Haiyan Group Inc.](http://www.haiyan.com.ph)|Manila, Filipinas|Haiyan Group Inc. desenvolve aplicativos Web e móveis para iOS e Android|

## <a name="poland"></a>Polônia

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Applandeo](http://www.applandeo.com/en/)|Krakow, Polônia|Applandeo é empresa de desenvolvimento de aplicativos e Web|
|[ASSECO POLAND S.A.](https://pl.asseco.com/)|Rzeszów, Polônia|A Asseco Polônia desenvolveu soluções de software tecnologicamente avançadas para empresas e instituições de todos os setores-chave da economia por mais de 20 anos|
|[Billennium](http://billennium.pl/)|Varsóvia, Polônia |A Billennium tem muitos anos de experiência em desenvolver ferramentas e soluções inovadoras de negócios.|
|[Edge One Solutions SP. z o.o.](http://www.edge1s.com)|Varsóvia, Polônia |Fornecemos as habilidades e a experiência de consultores de ti altamente qualificados. Em cada serviço em nosso portfólio, garantimos uma abordagem flexível às necessidades e expectativas do cliente|
|[SP do netbulls. z o.o.](http://www.netbulls.io)|Bialystok, Polônia|Obtenha suas ideias no skilfully do mercado. Sem desperdício de £ $ €, tempo ou desculpas. |
|[Sii](http://www.sii.pl/en)|Varsóvia, Polônia; Paris, França; Madri, Espanha; Berlim, Alemanha; Amsterdã, Países Baixos; Bruxelas, Bélgica; Cidade de Luxemburgo, Luxemburgo; Geneva, Suíça; Marrakesh, Marrocos; Praga, Czechia; Bucareste, Romênia; Toronto, no Canadá; Santiago, região do Santiago metropolitana, Chile; Buenos Aires, cidade autônoma de Buenos Aires, Argentina; Bogotá, Bogotá, Colômbia; Délhi, Índia|A SII é a principal empresa de serviços de ti na Polônia que dá suporte a programas de transformação digital, desde sua concepção até a entrega bem-sucedida e além. Fornecemos experiência no fornecimento de aplicativos empresariais e de consumidor que habilitam a comunicação do dispositivo, Big Data o tratamento e offline primeiro.|

## <a name="portugal"></a>Portugal

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Agap2](http://www.agap2.com)|Lisboa, Portugal|Agap2 – um grupo de consultoria e engenharia operacional Europeu especializado no setor e em ti|
|[Carbono em negrito](http://www.carbonbybold.com/)|Lisboa, Portugal|Carbono em negrito, é uma marca voltada para os serviços de consultoria móvel, ajudando as empresas a integrar o Mobile em suas estratégias de negócios. |
|[WIG](http://www.wig.pt)|Lisboa, Portugal|WIG tem uma atitude positiva, orgânica e personalizada. Eles veem clientes como parceiros e vivemos em seus problemas como se estivessem. O resultado é sempre positivo, flexível, real e pragmático.|

## <a name="russia"></a>Rússia

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Binwell Ltd.](https://www.binwell.com)|São Petersburgo, Rússia|O Binwell projeta e cria software personalizado, fornecendo soluções bem projetadas. Começamos a passar das necessidades de negócios e entender o ' valor ' exato que levamos ao cliente em cada etapa|
|[Notissimus](http://notissimus.com)|São Petersburgo, Rússia|Sua empresa trabalha em vendas ou serviços? Você chegou ao lugar certo. Novos projetos são sempre bem-vindos. |

## <a name="serbia"></a>Sérvia e Montenegro

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[INSSIO](http://inssio.com)|Belgrado, Sérvia|Desde a concepção do projeto até a distribuição do aplicativo, o INSSIO transforma suas ideias de negócios em software que conduz seus negócios|

## <a name="singapore"></a>Cingapura

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[CyanSYS](http://www.cyansys.com)|Cingapura Kuala Lumpur, Malásia; Makati, Filipinas; Hong Kong; Kota Kinabalu, Sabah, Malásia; Jacarta, Indonésia|A CyanSYS se esforça para fornecer soluções de qualidade de & escalonáveis para empresas de pequeno e médio porte, permitindo que elas concorram & crescer por meio da tecnologia da informação|
|[Xamariners](http://xamariners.com/)|Cingapura|Criamos aplicativos que são executados nativamente no iOS, Android, Windows e Mac com uma única base de código, bem como bots amigáveis e aplicativos de realidade aumentados.|

## <a name="slovakia"></a>Eslováquia

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Logamic](https://www.logamic.com/)|Bratislava, Eslováquia|Se você quiser adicionar um desenvolvedor do Xamarin dedicado à sua equipe, ou se quiser abordar todo o processo de desenvolvimento para você ou se gostaria de consultar o desenvolvimento móvel do Xamarin, fale conosco. |

## <a name="south-africa"></a>África do Sul

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Sistemas de software do AD](http://www.adsoftsystems.co.za)|Cidade do cabo, África do Sul|Os sistemas de software do AD oferecem soluções de desenvolvimento Web e móvel personalizadas. Eles se concentram no desenvolvimento nativo, mas também criaram soluções para permitir a reutilização máxima em todas as principais plataformas móveis|
|[CodeWrite Pty Ltd](http://www.codewrite.co.za/)|Joanesburgo, África do Sul|Nós nos concentramos em soluções móveis baseadas em aplicativos e baseadas na Web, aplicativos de software corporativos personalizados e integração de software do sistema de controle de acesso de segurança|
|[Cyberlogic Pty Ltd](http://www.cyberlogic.co.za)|Cidade do cabo, África do Sul|Cyberlogic é um provedor de serviços gerenciados de nuvem e serviços de ti gerenciados com data centers|
|[Pilha completa](http://www.fullstack.co.za/)|Cidade do cabo, África do Sul|A pilha completa é uma empresa de software que fornece produtos de dados e serviços projetados para desbloquear o valor comercial, por meio da entrega de software de qualidade no prazo, a um preço fixo.|
|[Novos laboratórios de mídia](http://www.newmedialabs.com)|Cidade do cabo, África do Sul|Nós specialisemos em aplicativos Web transacionais seguros para clientes de serviços financeiros. Esses sistemas de hiperraio são totalmente integrados às empresas de nossos clientes para fornecer melhorias significativas na eficiência e na capacidade de envolver seus clientes.|
|[Grupo de paradigmas](http://www.paradigmgroup.co.za/)|Cidade do cabo, África do Sul|O grupo de paradigmas é a divisão de desenvolvimento de software especialista no grupo. Eles fazem desenvolvimento de software personalizado para organizações corporativas, NGOs e governamentais.|
|[Consultoria de Sabersoft](https://www.sabersoft.co.za/)|África do Sul|Agora, as empresas podem colher as recompensas dos aplicativos móveis para alcançar novos mercados, obter conscientização, aprimorar a entrega de serviços e, em última análise, aumentar as receitas.|
|[Soluções de ti da tangente](http://tangentsolutions.co.za/)|África do Sul |As soluções da tangente foram fundada em 2010 e é uma casa de consultoria de desenvolvimento de transformação digital. Estamos com foco no código-fonte aberto e aproveitamos a participação em um ecossistema tecnológico rápido e em constante mudança. Nós somos a nuvem primeiro, DevOps primeiro e dispositivos móveis primeiro. |

## <a name="spain"></a>Espanha

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[DevsDNA](http://www.devsdna.com)|Seville, Espanha|Em DevsDNA, acreditamos que outra maneira de fazer negócios e criar software é possível. Infelizmente, nossa sociedade contemporânea não tem transparência, ética, princípios e uma bússola moral.|
|[KutirTech](http://www.kutirtech.com)|Malaga, Espanha  |Há mais de 13 anos, estamos criando e oferecendo suporte a aplicativos Web e móveis para clientes empresariais de grande e pequeno porte. Nós exploramos e experimentamos constantemente as melhores ferramentas e tecnologias de classe e reunimos a combinação certa de ferramentas e habilidades para tornar nossos clientes empresariais bem-sucedidos.|
|[Pasiona Consulting S. L](http://www.pasiona.com)|Barcelona, Espanha|Falamos em 2007 no local em que a escuta e a participação na caixa de diálogo com nossos clientes é a melhor maneira de fornecer soluções tecnológicas inovadoras adequadas às suas necessidades. Essa é nossa missão e nossa d'etre de raison. Somos uma empresa de consultoria especializada no desenvolvimento de soluções personalizadas para cada empresa, pois cada cliente é diferente e requer um tratamento exclusivo e exclusivo. Estamos comprometidos com a inovação, o trabalho de alta qualidade, o treinamento contínuo e o valor do teaRegional Premier humano|
|[TalentoMobile](http://www.talentomobile.com/)|Espanha |Somos originais digitais. Nós incentivamos seus processos de negócios e a conexão com seus clientes, tanto com nossas soluções quanto com nossos produtos.|
|[Vass consultoria de sistemas](http://www.vass.es/en)|Madri, Espanha; Barcelona, Espanha|A VASS é uma empresa de consultoria de ti, fundada em 1999, altamente especializada em novas tecnologias e produtos e serviços integrados com um conhecimento completo e uma tecnologia. Eles são uma empresa com um compromisso claro com a expansão internacional com uma presença em vários países na Europa e na América. VASS é uma empresa comprometida com a sociedade, gastando 2% do lucro para ações sociais.|

## <a name="sweden"></a>Suécia

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[BITZEAL](http://www.bitzeal.se)|Gothenburg, Suécia|O Bitzeal torna aplicativos baseados na Web, aplicativos de telefone e desktop e firmware|
|[Conevo IT Consulting AB](http://www.conevo.se)|Estocolmo, Suécia|Conevo é uma empresa de consultoria de ti que, por meio da grande capacidade de resposta para os negócios dos seus clientes, cria as melhores e mais sustentáveis soluções de ti de forma eficiente e modesta|
|[Criando ondas](http://www.makingwaves.com)|Estocolmo, Suécia|A criação de ondas aplica-se a estratégia, design e serviços de tecnologia para ajudar as empresas em negrito a transformar em negócios digitais bem-sucedidos. Com mais de 300 profissionais capacitados e entusiasmados, eles são um parceiro de inovação que oferece tudo o que você precisa para se tornar um vencedor digital.|

## <a name="switzerland"></a>Suíça

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Arendi](http://www.arendi.ch/)|Hombrechtikon, Suíça|O Arendi fornece uma ampla gama de serviços: desenvolvimento de aplicativos, desenvolvimento de hardware e firmware e gerenciamento de projetos |
|[AG dos serviços de software BBV](http://www.bbv.ch)|Zürich, Suíça|O BBV Software Services é uma empresa de consultoria e software suíço. Eles podem desenvolver soluções móveis que são adaptadas para seus requisitos de negócios específicos e complexos.|
|[A engenharia do narizr AG](http://www.noser.com)|Winterthur, Zürich |O nariz é um parceiro Gold da Microsoft para soluções de desenvolvimento, móveis e comerciais personalizadas. A Microsoft se chamasse engenharia de nariz AG, um Microsoft Gold Certified Partner, como o vencedor do prêmio de parceiro ALM (gerenciamento de ciclo de vida de aplicativos) da Microsoft 2012. Esse prêmio reconhece o compromisso pendente de fornecer soluções inovadoras de tecnologia e software da mais alta qualidade por meio da ALM bestship.|
|[Synapsis-grupo SPRL](http://www.synapsis-group.com)|Bruxelas |Nossa equipe de desenvolvimento de software tem um grande histórico de desenvolvimentos bem-sucedidos e com preço fixo com êxito para empresas de pequeno a grande porte. Seja em desktops, em plataformas Web ou móveis (iOS/Android/win8), temos todos os recursos que você precisa para avançar com seu projeto.|
|[TechTalk](http://www.techtalk.at)|Viena, Áustria; Zurique, Suíça|Oferecemos o melhor no desenvolvimento de software, economizando tempo e dinheiro enquanto protegemos a qualidade. |

## <a name="taiwan"></a>Taiwan

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[iscreeexception Corporation](http://www.iscreen.com)|Taipé, Taiwan|iScreen criou sua base em tecnologia sólida, com foco nos negócios na consultoria, no design e na criação de aplicativos Web e em qualquer plataforma móvel|
|[JetFusion Information Co., Ltd.](http://www.jetfusion.com.tw/)|Horário|Fornecemos serviços de construção de sistema e de desenvolvimento de software altamente flexíveis, em tempo real e profissionais, além de fornecer soluções completas do sistema de informações corporativas.|

## <a name="turkey"></a>Turquia

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Holograma LTD](http://hologramsoft.com/)|Istambul, Turquia|O holograma LTD é uma casa de desenvolvimento de software versátil, trabalhando tanto no espaço corporativo quanto no jogo, concentrando-se em várias plataformas|
|[Mobilist Bilisim Sistemleri](http://www.mobilist.com.tr)|Istambul, Turquia|Reunimos os designs inteligentes e de engenharia de alta qualidade para abrir soluções inovadoras.|

## <a name="uk"></a>BRITÂNICO

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Consultoria financeira adaptável limitada](http://weareadaptive.com)|Londres, Reino Unido|A consultoria financeira adaptável limitada é uma consultoria com ampla experiência no setor financeiro|
|[Apptelic Ltd](http://Apptelic.com)|Londres, Reino Unido|A Apptelic Ltd é uma empresa de desenvolvimento de software especializada no desenvolvimento de aplicativos móveis e de desktop para iOS, Android, Windows e Xbox.|
|[AppXib Ltd](http://www.appxib.com)|Peterborough, Reino Unido|AppXib é uma empresa de desenvolvimento de aplicativos|
|[Aplicativos Blue pássaro entrar na](http://www.bluesparrowapps.com/)|Bristol, Reino Unido|Os aplicativos Blue pássaro entrar na são uma empresa de desenvolvedor de aplicativos premiada|
|[Fábrica de aplicativos Chelsea](http://chelsea-apps.com/)|Londres, Reino Unido|O CAF fez um nome rapidamente para si mesmo como uma empresa líder no setor de desenvolvimento de aplicativos móveis do Reino Unido e a maior consultoria móvel de especialistas para consumidores e aplicativos empresariais|
|[Codificados Londres Ltd](http://getcodified.com/)|Londres, Reino Unido|A principal reagir do Londres e da agência do Xamarin|
|[Cohaesus](http://cohaesus.co.uk)|Londres, Reino Unido|O Cohaesus compila aplicativos nativos para alguns dos mundos maiores marcas, todos entregues em telefones iOS, Android e Windows|
|[Contemi](http://www.contemi.com)|Lysaker, Noruega; Lendo, Reino Unido|Contemi é o desenvolvimento de ti & empresa de consultoria de negócios desenvolvendo software para e com as iniciativas de inicialização.|
|[Ciências da Creative](https://creativesciences.co.uk)|Londres, Reino Unido|A Creative Sciences oferece serviços móveis e de desenvolvimento para a Web, consultoria e suporte. |
|[Datadruid](http://www.datadruid.co.uk)|Stortford da Bishop, Reino Unido|Fornecendo aplicativos robustos de alto desempenho e serviços de desenvolvimento. Entregue de maneira rápida e competitiva|
|[Eastpoint software](https://www.eastpoint.co.uk/)|Londres, Reino Unido|Somos uma casa de desenvolvimento de serviço completo que fornece estratégia e planejamento, design e UX, desenvolvimento, teste e manutenção e suporte|
|[Elemento 49](http://www.elementfortynine.com)|Londres, Reino Unido|O elemento 49 é uma consultoria móvel com foco em aplicativos, specialising no desenvolvimento móvel de plataforma cruzada e reutilização de código maximising, enquanto garante que a experiência do usuário é a prioridade mais alta|
|[Em qualquer momento](http://www.everis.com)|Londres, Reino Unido|Em qualquer momento, temos uma empresa de consultoria multinacional que oferece soluções comerciais e estratégicas, desenvolvimento e manutenção de aplicativos tecnológicos e serviços terceirizados|
|[Fujitsu](http://www.fujitsu.com/uk/services/application-services/application-development-integration/)||A Fujitsu é a principal empresa de tecnologia de comunicação e informações (ICT) para japonês que oferece uma gama completa de produtos, soluções e serviços de tecnologia|
|[Futurice](http://futurice.com)|Londres, Reino Unido; Munique, Alemanha; Helskinki, Finlândia|Desde 2001, a Futurice trabalhou em mais de 1000 projetos com mais de 200 clientes. Eles sabem como gerar ideias inovadoras e transformá-las em software que funciona|
|[Grupo de Grove](http://www.groveis.com/)|Londres, Reino Unido; Joanesburgo, África do Sul|Em Grove, desbloqueiamos o sucesso dos negócios por meio da tecnologia. Ajudamos você e sua empresa a atender ao seu potencial por meio do poder da computação em nuvem de ponta, desenvolvimento de software personalizado, segurança cibernética e análise|
|[Guimak Ltd.](http://www.guimak.com)|Londres, Reino Unido|Uma empresa de desenvolvimento de jogos|
|[Na mão Ltd](http://inthehand.com )|Newport, Shropshire, Reino Unido|A Hand Ltd. cria aplicativos e componentes para sistemas móveis, de realidade mista e de IoT|
|[BITS do iOS](http://iosbits.co.uk)|Londres, Reino Unido|os BITS do iOS são habilitadores de inovação móvel. Eles sabem como criar experiências de usuário poderosas e ferramentas de negócios por meio do uso criativo de tecnologias emergentes|
|[iScientia limitado](http://www.iscientia.co.uk/)|Surrey, Reino Unido|Oferecemos consultoria e soluções de sistemas de informações principalmente para indústrias de hospedagem, varejo e pagamento.|
|[Microssegundos](http://www.microsec.co.uk/)|Hampshire, Reino Unido|Nas últimas três décadas, a microssegundos criou soluções de software desenvolvidas e com suporte usando praticamente todas as tecnologias em uso básico.|
|[Motech Ltd.](http://www.motechltd.com)|Londres, Reino Unido; Riga, Letônia|A Motech Ltd Enterprise Mobile Solutions é uma empresa de tecnologia internacional, aproveitando o conhecimento de mais de 12 anos na entrega de aplicativos empresariais para empresas globais para fornecer o melhor valor em aplicativos móveis empresariais|
|[Gerenciamento de pixel Ltd](http://pml.co.uk)|Solihull, oeste Midlands, Reino Unido|Os projetos de PML incluíam aplicativos corporativos, comerciais e educacionais. As competências principais da empresa abrangem várias linguagens de programação, desenvolvimento móvel nativo e de nuvem, sistemas de segurança complexos, imagem ainda, compactação de vídeo e streaming. |
|[Proto software](https://www.protosoftware.co.uk/)|Reino Unido|Podemos desenvolver aplicativos móveis para sua empresa em uma variedade de plataformas, incluindo iOS, Android e Windows, oferecendo a você um alcance de mais de 3.000.000.000 clientes em potencial. |
|[Raramente impossível](http://www.rarelyimpossible.com)|Bournemouth, Reino Unido|Raramente não é possível ajudar as empresas a criar aplicativos móveis e soluções de nuvem IoT para resolver problemas de negócios, concentrando-se na experiência do usuário durante os estágios de design e desenvolvimento. Por meio dos projetos e produtos que criamos para nossos clientes, nosso objetivo é capacitar todos em uma organização com ferramentas que os ajudem em todos os dias.|
|[Conhecimento sólido de rock](http://www.rocksolidknowledge.com)|Bristol, Reino Unido|Como parceiros Xamarin, podemos criar soluções móveis de plataforma cruzada usando o Xamarin Forms e a interface do usuário nativa no iOS e no Android. Temos experiência em desenvolver soluções que fornecem a aparência da interface do usuário nativa ao compartilhar tudo, ou uma grande quantidade de código, entre as plataformas.|
|[Screenmedia](http://www.screenmedia.co.uk)|Glasgow, Reino Unido|O Screenmedia acredita que, para criar soluções centradas no homem para clientes e usuários finais, eles devem ser um negócio centralizado. Sua visão e seus valores refletem isso e naturalmente, portanto, as pessoas. A cultura de prática do Screenmedia é a chave para seu sucesso. São as unidades e sustentam sua inovação contínua em tecnologias emergentes; ajuda a criar parcerias ágeis com clientes; e é isso que torna o trabalho muito desafiador.|
|[Sequência](https://www.sequence.co.uk/)|Cardiff, Reino Unido; Londres, Reino Unido|Sequence é uma agência digital criativa estabelecida em 1995. Specialising em design, estratégia e experiência do usuário, eles trabalharam com algumas das maiores organizações do Reino Unido em setores que vão desde a fabricação até a viagem e a turismo. Conectar marcas com seus clientes por meio de paixão e inovação.|
|[ShinobiSolutions](https://www.shinobicontrols.com/shinobienterprise)|Newcastle no Tyne, Reino Unido|Desde sua concepção em 2011, a Shinobicontrols vem criando controles de interface do usuário interativos e poderosos e abrangentes para desenvolvedores de Android e iOS. Por 2012, eles lançaram o shinobicharts, seu primeiro produto. Desde então, eles cresceram rapidamente e agora fornecem soluções de interface do usuário para milhares de clientes com nosso amplo portfólio de produtos em rápida expansão.|
|[Skillweb](http://www.skillweb.co.uk)|Alta Wycombe, Reino Unido|O Skillweb é uma empresa privada, baseada no Reino Unido, que fornece soluções de tecnologia projetadas para ajudar as organizações a gerenciarem suas forças de trabalho móveis e acompanharem o movimento de suas mercadorias. A empresa foi operada desde 1999 Gerenciando implantações no Reino Unido e na Europa e é responsável por até 100 milhões transações por mês e aumentando.|
|[Software resolvido](http://www.softwaresolved.com/)|Exeter, Reino Unido; Londres, Reino Unido; Manchester, Reino Unido|Criamos parcerias de longo prazo com nossos clientes com base na confiança e na entrega de softwares pendentes. Somos um parceiro Gold da Microsoft e nossos processos são certificados ISO 9001.  Isso significa que estamos capacitados com os padrões de qualidade mais alta no desenvolvimento de software.|
|[StyleTech](https://www.styletech.co.uk/)|Envoltória, Reino Unido|Somos especialistas em software de hiperraio, desenvolvendo soluções personalizadas de ponta para atender aos requisitos dos nossos clientes e, ao mesmo tempo, dar suporte, manutenção e aprimoramento de sistemas herdados. Operando desde 1999, apresentamos um registro de acompanhamento do fornecimento de mais de 1000 projetos de software de hiperspoke para uma variedade diversificada de clientes de setores públicos e privados, nós specialise nos setores de saúde, científica, transporte, manufatura e tecnologia. Com uma cultura que pode ser alcançada e amigável, sempre fornecemos um serviço focado e de qualidade para todos os nossos clientes. Trabalhando com o Xamarin, Xamarin Test Cloud e o Azure, somos especialistas em desenvolvimento móvel, Tablet, nuvem, Web ou desktop e sempre aplicam práticas recomendadas às áreas de análise, design, segurança, teste e integração.|
|[Superluminal](http://www.superluminalsoftware.co.uk)|Oxford, Reino Unido|Aqui em superluminal somos engenheiros de software, então projetamos nosso software do zero, construindo sistemas críticos que se alinham ao processo e hipercarregam seus negócios. Também podemos manter e atualizar seu sistema atual se ele começar a atrapalhar ou exigir alteração para atender às necessidades dos negócios.|
|[A empresa de aplicativo do bespoke é limitada](http://www.thebespokeappcompany.co.uk)|Barrowford, Reino Unido; Distrito do oeste do Norte Leicestershire, Reino Unido||
|[Thumbmunkeys Ltd](http://www.thumbmunkeys.com)|York, Norte Yorkshire, Reino Unido|Com um registro de faixa que inclui a criação de aplicativos de consumidor com mais de 30 milhões downloads, Thumbmunkeys saiba como criar uma experiência móvel verdadeiramente excepcional e atraente para o usuário. Nossa equipe baseada no Reino Unido de desenvolvedores e designers especializados oferece uma solução personalizada de ponta a ponta de consultoria para criação de protótipos, design de interface do usuário/UX, desenvolvimento de várias plataformas, desenvolvimento em nuvem & suporte técnico contínuo.|
|[VoxDev Ltd](http://www.voxdevmobile.com)|Durham, Reino Unido|O VoxDev foi formado em 2003 e de nossa base em Durham no nordeste da Inglaterra, ajudamos os clientes com seus projetos de software criando sites, desktops e aplicativos móveis com êxito.|
|[Waterstons LTD](https://waterstons.com)|Durham, Reino Unido|Crie um negócio melhor. Por meio de tecnologia, experiência e compromisso, o Waterstons trabalha com centenas de clientes, grandes ou pequenos, para melhorar seus negócios.|
|[Xpandir](http://www.xpand-it.com)|Lisboa, Portugal; Londres, Reino Unido|Com vários anos de experiência no mundo móvel e mais de 130 aplicativos móveis disponíveis nos diferentes Marketplaces, xpandir ele é líder em serviços de aplicativos móveis empresariais.|
|[YARG limitado](http://www.yarg.com)|Londres, Reino Unido|O YARG desenvolve aplicativos móveis de plataforma cruzada para iPhone, iPad, Android e Windows Phone. Eles se orgulham de fornecer valor, qualidade do produto e altos níveis de serviço pessoal.|
|[Sistemas Zepto limitados](http://www.zeptosystems.com )|Londres, Reino Unido|Transformando a terceirização e o internacional para a inteligência inteligente. Aumente a capacidade e as habilidades internas com funcionários remotos para economizar tempo, custo (até 60%), contratação e retenção.|

## <a name="ukraine"></a>Ucrânia

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[FreezePro Software](http://freezeprosoftware.com)|Lviv, Ucrânia|O FreezePro software é uma empresa personalizada de desenvolvimento e terceirização de software. Ele foi estabelecido por profissionais de Enterprising com planos de fundo de ti fortes.|
|[Inovações de GUI limitadas](http://www.gui-innovations.com)|Kiev, Ucrânia|Fornecemos soluções de software para um mundo móvel. Temos unrivalled experiência em projetar, desenvolver e dar suporte a software para muitas plataformas|
|[Neadevis](http://neadevis.com/)|Lviv, Ucrânia|A satisfação do cliente e as soluções de alta qualidade são os fundamentos de nossos negócios. Nossos clientes no trabalho nos fornecem pontuações de comentários foras. Saiba mais sobre o que os clientes estão dizendo sobre nós.|

## <a name="uruguay"></a>Uruguai

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[Nareia](http://nareia.com.uy)|Uruguai|Somos apaixonados pelo mundo móvel, nós realmente adoramos criar aplicativos incríveis para iOS e Android e temos uma ótima experiência em desenvolvimento móvel com o Xamarin.  |

## <a name="vietnam"></a>Vietnã

| Parceiro | Locais | Descrição |
| --- | --- | --- |
|[DVLUP](http://www.dvlup.net/)|Ho Chi Minh City, Vietnã|O desenvolvimento foi fundada por líderes de comunidade de desenvolvimento com a missão de redistribuir os desenvolvedores do Vietnã|
|[FPT software Hanói Company Limited](http://www.fpt-software.com/)|Hanói, Vietnã|O maior e um dos mais rápidos provedores de serviços de transformação digital em crescimento.|
