...
description: Este documento descreve como substituir suas referências de componente com pacotes do NuGet para obsoleta seus aplicativos, como o armazenamento do componente Xamarin foi descontinuado.
