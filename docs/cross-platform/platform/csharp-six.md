...
* **O Visual Studio 2015 e 2017** e superior têm suporte completo para o c# 6. Versões anteriores do Visual Studio (por exemplo. 2013, 2012) não oferecerá suporte c# 6.
