...
Os usuários do Windows devem ter [Visual Studio 2015 ou 2017 ^](https://visualstudio.microsoft.com/) instalado para compilar o código c# 6 (mesmo se você escolher o Xamarin Studio para Windows como seu IDE).
