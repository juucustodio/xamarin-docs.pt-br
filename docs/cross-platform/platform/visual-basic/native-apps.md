...
description: Este passo a passo demonstra como criar aplicativos nativos de xamarin e xamarin que usam a lógica de negócios escrita em Visual Basic.NET.
ms.prod: xamarin
