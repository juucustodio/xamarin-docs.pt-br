...
description: Este documento fornece uma comparação dos controles de interface do usuário entre o xamarin. Forms, Windows Forms e WPF. Ele também fornece links para outros documentos que compara o WPF para xamarin. Forms.
author: asb3993
ms.author: amburns
ms.date: 04/26/2017
...
ms.locfileid: "61273927"
---
# <a name="ui-controls-comparison"></a>Comparação de controles de interface do usuário

Abaixo está uma comparação de controles de Windows Forms e WPF, com base no xamarin. Forms [nesta tabela](/dotnet/framework/wpf/advanced/windows-forms-controls-and-equivalent-wpf-controls).

Leia mais sobre o [semelhanças e diferenças entre o WPF e o xamarin. Forms](wpf.md) para ajudar a atualizar o seu conhecimento da área de trabalho para o desenvolvimento de aplicativos móveis.
...
|[ComboBox](https://msdn.microsoft.com/library/system.windows.forms.combobox(v=vs.110).aspx)|[Caixa de combinação](https://msdn.microsoft.com/library/system.windows.controls.combobox(v=vs.110).aspx) (não oferecer suporte a auto-completar)|Seletor|
...
|[DomainUpDown](https://msdn.microsoft.com/library/system.windows.forms.domainupdown(v=vs.110).aspx)|[Caixa de texto](https://msdn.microsoft.com/library/system.windows.controls.textbox(v=vs.110).aspx) e duas [RepeatButton](https://msdn.microsoft.com/library/system.windows.controls.primitives.repeatbutton(v=vs.110).aspx) controles.|Escalonador|
|[ErrorProvider](https://msdn.microsoft.com/library/system.windows.forms.errorprovider(v=vs.110).aspx)|-|-|
|[FlowLayoutPanel](https://msdn.microsoft.com/library/system.windows.forms.flowlayoutpanel(v=vs.110).aspx)|[WrapPanel](https://msdn.microsoft.com/library/system.windows.controls.wrappanel(v=vs.110).aspx) ou [StackPanel](https://msdn.microsoft.com/library/system.windows.controls.stackpanel(v=vs.110).aspx)|StackLayout ou WrapLayout controle personalizado|
...
|[HelpProvider](https://msdn.microsoft.com/library/system.windows.forms.helpprovider(v=vs.110).aspx)|Nenhum controle equivalente (use as dicas de ferramentas).|-|
|[HScrollBar](https://msdn.microsoft.com/library/system.windows.forms.hscrollbar(v=vs.110).aspx)|[Barra de rolagem](https://msdn.microsoft.com/library/system.windows.controls.primitives.scrollbar(v=vs.110).aspx) (rolagem baseia-se em controles de contêiner)|usar ScrollView|
...
|[LinkLabel](https://msdn.microsoft.com/library/system.windows.forms.linklabel(v=vs.110).aspx)|Nenhum controle equivalente (você pode usar o [hiperlink](https://msdn.microsoft.com/library/system.windows.documents.hyperlink(v=vs.110).aspx) classe para hospedar hiperlinks dentro do conteúdo de fluxo).|-|
|[ListBox](https://msdn.microsoft.com/library/system.windows.forms.listbox(v=vs.110).aspx)|[ListBox](https://msdn.microsoft.com/library/system.windows.controls.listbox(v=vs.110).aspx)|Usar o ListView|
...
|[NumericUpDown](https://msdn.microsoft.com/library/system.windows.forms.numericupdown(v=vs.110).aspx)|[Caixa de texto](https://msdn.microsoft.com/library/system.windows.controls.textbox(v=vs.110).aspx) e duas [RepeatButton](https://msdn.microsoft.com/library/system.windows.controls.primitives.repeatbutton(v=vs.110).aspx) controles.|Escalonador|
...
|[RichTextBox](https://msdn.microsoft.com/library/system.windows.forms.richtextbox(v=vs.110).aspx)|[RichTextBox](https://msdn.microsoft.com/library/system.windows.controls.richtextbox(v=vs.110).aspx)|Editor não oferece suporte a rich text e (formatado), entrada de texto de única linha|
...
|[TreeView](https://msdn.microsoft.com/library/system.windows.forms.treeview(v=vs.110).aspx)|[TreeView](https://msdn.microsoft.com/library/system.windows.controls.treeview(v=vs.110).aspx)|Considere o ListView hierárquico em uma NavigationPage|
|[UserControl](https://msdn.microsoft.com/library/system.windows.forms.usercontrol(v=vs.110).aspx)|[UserControl](https://msdn.microsoft.com/library/system.windows.controls.usercontrol(v=vs.110).aspx)|Modo de exibição e também os renderizadores personalizados|
