...
description: Este documento descreve as etapas que devem ser seguidas para atualizar um aplicativo xamarin da API clássica para a API unificada.
ms.prod: xamarin
