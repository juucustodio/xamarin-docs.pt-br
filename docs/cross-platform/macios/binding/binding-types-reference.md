...
description: Este guia de referência descreve vários atributos e conceitos que são necessárias para entender quando criar associações do c# para bibliotecas Objective-C.
ms.prod: xamarin
