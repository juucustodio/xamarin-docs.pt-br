...
description: Este documento fornece uma visão geral das ferramentas incluídas com o objetivo de Sharpie e os argumentos de linha de comando para usar com eles.
ms.prod: xamarin
