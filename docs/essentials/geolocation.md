...
Você deve definir o `Location` permissão para o aplicativo. Isso pode ser feito abrindo o **Package. appxmanifest** e selecionando o **funcionalidades** guia e verificando **local**.
