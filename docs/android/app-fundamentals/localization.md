...
Cada cadeia de caracteres traduzível é um elemento XML com a ID de recurso especificada `name` como o atributo e a cadeia de caracteres traduzida como o valor:
