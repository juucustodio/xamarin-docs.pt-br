...
[![Adicionar novo botão de aplicativo](manually-uploading-the-apk-images/01-existing-app-sml.png)](manually-uploading-the-apk-images/01-existing-app.png#lightbox)

Quando a caixa de diálogo **ADICIONAR NOVO APLICATIVO** for exibida, insira o nome do aplicativo e clique em **Carregar APK**:

[![Carregar botão APK](manually-uploading-the-apk-images/02-add-new-application-sml.png)](manually-uploading-the-apk-images/02-add-new-application.png#lightbox)
...
[![Carregue seu primeiro APK para o botão Alfa](manually-uploading-the-apk-images/03-upload-to-alpha-sml.png)](manually-uploading-the-apk-images/03-upload-to-alpha.png#lightbox)
...
[![Faça upload do novo apk para a caixa de diálogo Alpha](manually-uploading-the-apk-images/04-upload-dialog-sml.png)](manually-uploading-the-apk-images/04-upload-dialog.png#lightbox)
...
[![Indicação de progresso de upload](manually-uploading-the-apk-images/05-upload-progress-sml.png)](manually-uploading-the-apk-images/05-upload-progress.png#lightbox)

Depois que o APK for carregado, será possível selecionar um método de teste:

[![Escolha uma caixa de diálogo Método de teste](manually-uploading-the-apk-images/06-select-testing-method-sml.png)](manually-uploading-the-apk-images/06-select-testing-method.png#lightbox)
...
[![Diálogo de listagem de lojas](manually-uploading-the-apk-images/07-store-listing-sml.png)](manually-uploading-the-apk-images/07-store-listing.png#lightbox)
...
[![Seção de categorização](manually-uploading-the-apk-images/09-categorization-sml.png)](manually-uploading-the-apk-images/09-categorization.png#lightbox)
...
[![Seção Detalhes de Contato](manually-uploading-the-apk-images/10-contact-details-sml.png)](manually-uploading-the-apk-images/10-contact-details.png#lightbox)
...
[![Seção de classificação de conteúdo](manually-uploading-the-apk-images/11-content-rating-sml.png)](manually-uploading-the-apk-images/11-content-rating.png#lightbox)
...
[![Diálogo de Preços e Distribuição](manually-uploading-the-apk-images/12-pricing-sml.png)](manually-uploading-the-apk-images/12-pricing.png#lightbox)
...
[![Gerenciar o diálogo entre países](manually-uploading-the-apk-images/13-manage-countries-sml.png)](manually-uploading-the-apk-images/13-manage-countries.png#lightbox)
...
[![Contém seção de anúncios](manually-uploading-the-apk-images/14-contains-ads-sml.png)](manually-uploading-the-apk-images/14-contains-ads.png#lightbox)
...
[![Seção de consentimento](manually-uploading-the-apk-images/15-consent-sml.png)](manually-uploading-the-apk-images/15-consent.png#lightbox)
...
- [uso-configuração](https://developer.android.com/guide/topics/manifest/uses-configuration-element.html) &ndash; Este elemento manifesto é usado para solicitar certos recursos de hardware, como o tipo de teclado, dispositivos de navegação, uma tela sensível ao toque, etc. Este elemento deve ser adicionado ao **AndroidManifest.xml** manualmente.
