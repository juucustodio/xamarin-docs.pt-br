...
O exemplo a seguir mostra como usar o [IntentFilterAttribute](xref:Android.App.IntentFilterAttribute) para manipular links de `https://www.recipe-app.com/recipes` e para `http://www.recipe-app.com/recipes` :
...
> [!NOTE]
> O `android:autoVerify` atributo deve ser definido pelo filtro de intenção &ndash; , caso contrário, o Android não executará a verificação.
