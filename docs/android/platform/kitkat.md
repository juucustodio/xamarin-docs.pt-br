...
-  *Espelhar recursos Desenháveis* -recursos Desenháveis possui um novo [`autoMirrored`](https://developer.android.com/reference/android/R.attr.html#autoMirrored)
