...
---
# <a name="android-wear"></a>Desgaste Android
...
##  <a name="platform-featuresandroidwearplatformindexmd"></a>[Recursos de plataforma](~/android/wear/platform/index.md)
...
##  <a name="deployment--testingandroidweardeploy-testindexmd"></a>[& Teste de implantação](~/android/wear/deploy-test/index.md)
