...
#### [Visualização do Microsoft Mobile OpenJDK](get-started/installation/openjdk.md)
...
### [Acesso ao arquivo com o Xamarin.Android](platform/files/index.md)
#### [Armazenamento externo](platform/files/external-storage.md)
...
### [Visualização do Android P](platform/android-p.md)
...
### [Inicializador](~/essentials/launcher.md?context=xamarin/android)
...
### [Mapas](~/essentials/maps.md?context=xamarin/android)
### [Abrir Navegador](~/essentials/open-browser.md?context=xamarin/android)
### [Sensor de orientação](~/essentials/orientation-sensor.md?context=xamarin/android)
