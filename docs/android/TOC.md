...
##### [Visão geral de TabHost](user-interface/layouts/tab-layout/tab-host.md)
##### [Criar uma interface do usuário com guias com TabHost](user-interface/layouts/tab-layout/creating-a-tabbed-ui.md)
...
#### [Implementar com fragmentos](platform/fragments/implementing-with-fragments/index.md)
##### [Passo a passo](platform/fragments/implementing-with-fragments/walkthrough.md)
##### [Suporte a pré-Honeycomb](platform/fragments/implementing-with-fragments/supporting-pre-honeycomb.md)
...
### [Serviços conectados do Azure](~/cross-platform/data-cloud/connected-services.md?context=xamarin/android)
...
#### [Emulador do SDK do Android](deploy-test/debugging/android-sdk-emulator/index.md)
