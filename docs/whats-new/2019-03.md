...
- [Xamarin.Forms QuickStarts](~/get-started/quickstarts/index.md)
  - [Crie um aplicativo Xamarin.Forms de página única](~/get-started/quickstarts/single-page.md)
...
- [Específico da plataforma do iOS: ListView Row Animations](~/xamarin-forms/platform/ios/listview-row-animations.md)
- [específico da plataforma do iOS: ListView Group Header Style](~/xamarin-forms/platform/ios/listview-group-header-style.md)
- [específico da plataforma do iOS: Cor de fundo de célula](~/xamarin-forms/platform/ios/cell-background-color.md)
...
- [Editor: Habilitando e desativando a previsão de texto](~/xamarin-forms/user-interface/text/editor.md#enabling-and-disabling-text-prediction)
