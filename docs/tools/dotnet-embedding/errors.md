...
description: Este documento descreve os erros gerados pela inserção de .NET. Erros são listados por código e receber uma descrição para ajudar a solucionar o problema.
ms.prod: xamarin
