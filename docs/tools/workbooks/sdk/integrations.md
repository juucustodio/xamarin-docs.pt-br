...
description: Este documento descreve tópicos avançados relacionados a integrações de pastas de trabalho do Xamarin. Ele aborda o pacote Xamarin.Workbook.Integrations NuGet e exposição de API dentro de uma pasta de trabalho do Xamarin.
ms.prod: xamarin
