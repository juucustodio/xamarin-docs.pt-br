...
Às vezes, você desejará parar de receber notificações para o evento, nesses casos, salvar o valor de retorno da chamada para o `SubscribeTo` método e invocar o método de cancelamento de assinatura nele:
