...
<table>
    <thead>
        <tr>
            <th>Dispositivo</th>
            <th>Resolução de vídeo</th>
            <th>Captura de tela de exemplo</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td>Exibição desejada</td>
            <td>368 x 240 (com barras pretas para taxa de proporção)</td>
            <td><img src="resolutions-images/image1.png" title="368 x 240 (com barras pretas para taxa de proporção)" /></td>
        </tr>
        <tr>
            <td>iPhone 4s</td>
            <td>960x640</td>
...
- [Introdução de CocosSharp](~/graphics-games/cocossharp/first-game/index.md)
